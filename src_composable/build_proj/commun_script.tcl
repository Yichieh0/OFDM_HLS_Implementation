...
#
# commun_script.tcl: Tcl script for re-creating project 'composable_communcation'
#
# Generated by Vivado on Tue Feb 14 21:21:11 CST 2023
...
#
# 1. This project restoration tcl script (commun_script.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "./composable_IP_file/pixl2sym_src"]"]"\
 "[file normalize "./composable_IP_file/ecc_encoder_src"]"]"\
 "[file normalize "./composable_IP_file/ecc_decoder_src"]"]"\
 "[file normalize "./composable_IP_file/pilot_equalizer_src/pilot/project"]"]"\
 "[file normalize "./composable_IP_file/sym2pixl_src"]"]"\
 "[file normalize "./composable_IP_file/pilot_insertion/pilot/project"]"]"\
 "[file normalize "./composable_IP_file/FFT_src/fft/project"]"]"\
 "[file normalize "./composable_IP_file/CP_remove_src/CP/project"]"]"\
 "[file normalize "./composable_IP_file/channel_src/channel/project"]"]"\
 "[file normalize "./composable_IP_file/QAM_src/project/qam"]"]"\
 "[file normalize "./composable_IP_file/deQAM_src/project/qam"]"]"\
 "[file normalize "./composable_IP_file/QAM_RTL_IP"]"]"\
 "[file normalize "./composable_IP_file/IFFT_src/fft/project"]"]"\
 "[file normalize "./composable_IP_file/CP_insert_src"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "commun_script.tcl"
...
if { $obj != {} } {
	set_property "ip_repo_paths" "[file normalize "./composable_IP_file/pixl2sym_src"] [file normalize "./composable_IP_file/ecc_encoder_src"] [file normalize "./composable_IP_file/ecc_decoder_src"] [file normalize "./composable_IP_file/pilot_equalizer_src/pilot/project"] [file normalize "./composable_IP_file/sym2pixl_src"] [file normalize "./composable_IP_file/pilot_insertion/pilot/project"] [file normalize "./composable_IP_file/FFT_src/fft/project"] [file normalize "./composable_IP_file/CP_remove_src/CP/project"] [file normalize "./composable_IP_file/channel_src/channel/project"] [file normalize "./composable_IP_file/QAM_src/project/qam"] [file normalize "./composable_IP_file/deQAM_src/project/qam"] [file normalize "./composable_IP_file/QAM_RTL_IP"] [file normalize "./composable_IP_file/IFFT_src/fft/project"] [file normalize "./composable_IP_file/CP_insert_src"]" $obj
...
proc create_hier_cell_comm { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net CP_insertion_0_data_out [get_bd_intf_pins CP_insertion_0/data_out] [get_bd_intf_pins axis_switch/S11_AXIS]
  connect_bd_intf_net -intf_net CP_removal_0_data_out [get_bd_intf_pins CP_removal_0/data_out] [get_bd_intf_pins axis_switch/S13_AXIS]
  connect_bd_intf_net -intf_net QAM_0_data_out [get_bd_intf_pins QAM_0/data_out] [get_bd_intf_pins axis_switch/S05_AXIS]
  connect_bd_intf_net -intf_net QAM_1_m_axis [get_bd_intf_pins QAM_1/m_axis] [get_bd_intf_pins axis_switch/S12_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_switch_M02_AXIS [get_bd_intf_pins axis_switch/M02_AXIS] [get_bd_intf_pins symbol_to_pixl_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M03_AXIS [get_bd_intf_pins axis_switch/M03_AXIS] [get_bd_intf_pins encoder_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M04_AXIS [get_bd_intf_pins axis_switch/M04_AXIS] [get_bd_intf_pins decoder_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M05_AXIS [get_bd_intf_pins QAM_0/data_in] [get_bd_intf_pins axis_switch/M05_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M06_AXIS [get_bd_intf_pins axis_switch/M06_AXIS] [get_bd_intf_pins deQAM_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M07_AXIS [get_bd_intf_pins axis_switch/M07_AXIS] [get_bd_intf_pins pilot_insertion_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M08_AXIS [get_bd_intf_pins axis_switch/M08_AXIS] [get_bd_intf_pins equalizer_pilot_remo_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M09_AXIS [get_bd_intf_pins axis_switch/M09_AXIS] [get_bd_intf_pins fft_top0_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M10_AXIS [get_bd_intf_pins axis_switch/M10_AXIS] [get_bd_intf_pins fft_top1_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M11_AXIS [get_bd_intf_pins CP_insertion_0/data_in] [get_bd_intf_pins axis_switch/M11_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M12_AXIS [get_bd_intf_pins QAM_1/s_axis] [get_bd_intf_pins axis_switch/M12_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M13_AXIS [get_bd_intf_pins CP_removal_0/data_in] [get_bd_intf_pins axis_switch/M13_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M14_AXIS [get_bd_intf_pins axis_switch/M14_AXIS] [get_bd_intf_pins channel_gen_0/data_in]
  connect_bd_intf_net -intf_net channel_gen_0_data_out [get_bd_intf_pins axis_switch/S14_AXIS] [get_bd_intf_pins channel_gen_0/data_out]
  connect_bd_intf_net -intf_net deQAM_0_data_out [get_bd_intf_pins axis_switch/S06_AXIS] [get_bd_intf_pins deQAM_0/data_out]
  connect_bd_intf_net -intf_net decoder_0_data_out [get_bd_intf_pins axis_switch/S04_AXIS] [get_bd_intf_pins decoder_0/data_out]
  connect_bd_intf_net -intf_net encoder_0_data_out [get_bd_intf_pins axis_switch/S02_AXIS] [get_bd_intf_pins encoder_0/data_out]
  connect_bd_intf_net -intf_net equalizer_pilot_remo_0_data_out [get_bd_intf_pins axis_switch/S08_AXIS] [get_bd_intf_pins equalizer_pilot_remo_0/data_out]
  connect_bd_intf_net -intf_net fft_top0_0_data_out [get_bd_intf_pins axis_switch/S09_AXIS] [get_bd_intf_pins fft_top0_0/data_out]
  connect_bd_intf_net -intf_net fft_top1_0_data_out [get_bd_intf_pins axis_switch/S10_AXIS] [get_bd_intf_pins fft_top1_0/data_out]
  connect_bd_intf_net -intf_net pilot_insertion_0_data_out [get_bd_intf_pins axis_switch/S07_AXIS] [get_bd_intf_pins pilot_insertion_0/data_out]
  ...
  connect_bd_intf_net -intf_net symbol_to_pixl_0_data_out [get_bd_intf_pins axis_switch/S01_AXIS] [get_bd_intf_pins symbol_to_pixl_0/data_out]
...
if { [get_property IS_LOCKED [ get_files -norecurse commun.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../composable_IP_file/composable_communcation/composable_communcation.gen/sources_1/bd/commun/hdl/commun_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/composable_communcation.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/composable_communcation.srcs/utils_1/imports/impl_1" -objects $obj
