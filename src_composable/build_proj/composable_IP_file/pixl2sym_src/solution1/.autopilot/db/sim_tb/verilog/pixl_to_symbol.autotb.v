...
`define AUTOTB_DUT      pixl_to_symbol
`define AUTOTB_DUT_INST AESL_inst_pixl_to_symbol
`define AUTOTB_TOP      apatb_pixl_to_symbol_top
`define AUTOTB_LAT_RESULT_FILE "pixl_to_symbol.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "pixl_to_symbol.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_pixl_to_symbol_top
...
`define AUTOTB_TVIN_data_in_V_data_V  "./c.pixl_to_symbol.autotvin_data_in_V_data_V.dat"
`define AUTOTB_TVIN_data_in_V_keep_V  "./c.pixl_to_symbol.autotvin_data_in_V_keep_V.dat"
`define AUTOTB_TVIN_data_in_V_strb_V  "./c.pixl_to_symbol.autotvin_data_in_V_strb_V.dat"
`define AUTOTB_TVIN_data_in_V_last_V  "./c.pixl_to_symbol.autotvin_data_in_V_last_V.dat"
`define AUTOTB_TVIN_data_out_V_data_V  "./c.pixl_to_symbol.autotvin_data_out_V_data_V.dat"
`define AUTOTB_TVIN_data_out_V_keep_V  "./c.pixl_to_symbol.autotvin_data_out_V_keep_V.dat"
`define AUTOTB_TVIN_data_out_V_strb_V  "./c.pixl_to_symbol.autotvin_data_out_V_strb_V.dat"
`define AUTOTB_TVIN_data_out_V_last_V  "./c.pixl_to_symbol.autotvin_data_out_V_last_V.dat"
`define AUTOTB_TVIN_data_in_V_data_V_out_wrapc  "./rtl.pixl_to_symbol.autotvin_data_in_V_data_V.dat"
`define AUTOTB_TVIN_data_in_V_keep_V_out_wrapc  "./rtl.pixl_to_symbol.autotvin_data_in_V_keep_V.dat"
`define AUTOTB_TVIN_data_in_V_strb_V_out_wrapc  "./rtl.pixl_to_symbol.autotvin_data_in_V_strb_V.dat"
`define AUTOTB_TVIN_data_in_V_last_V_out_wrapc  "./rtl.pixl_to_symbol.autotvin_data_in_V_last_V.dat"
`define AUTOTB_TVIN_data_out_V_data_V_out_wrapc  "./rtl.pixl_to_symbol.autotvin_data_out_V_data_V.dat"
`define AUTOTB_TVIN_data_out_V_keep_V_out_wrapc  "./rtl.pixl_to_symbol.autotvin_data_out_V_keep_V.dat"
`define AUTOTB_TVIN_data_out_V_strb_V_out_wrapc  "./rtl.pixl_to_symbol.autotvin_data_out_V_strb_V.dat"
`define AUTOTB_TVIN_data_out_V_last_V_out_wrapc  "./rtl.pixl_to_symbol.autotvin_data_out_V_last_V.dat"
`define AUTOTB_TVOUT_data_out_V_data_V  "./c.pixl_to_symbol.autotvout_data_out_V_data_V.dat"
`define AUTOTB_TVOUT_data_out_V_keep_V  "./c.pixl_to_symbol.autotvout_data_out_V_keep_V.dat"
`define AUTOTB_TVOUT_data_out_V_strb_V  "./c.pixl_to_symbol.autotvout_data_out_V_strb_V.dat"
`define AUTOTB_TVOUT_data_out_V_last_V  "./c.pixl_to_symbol.autotvout_data_out_V_last_V.dat"
`define AUTOTB_TVOUT_data_out_V_data_V_out_wrapc  "./impl_rtl.pixl_to_symbol.autotvout_data_out_V_data_V.dat"
`define AUTOTB_TVOUT_data_out_V_keep_V_out_wrapc  "./impl_rtl.pixl_to_symbol.autotvout_data_out_V_keep_V.dat"
`define AUTOTB_TVOUT_data_out_V_strb_V_out_wrapc  "./impl_rtl.pixl_to_symbol.autotvout_data_out_V_strb_V.dat"
`define AUTOTB_TVOUT_data_out_V_last_V_out_wrapc  "./impl_rtl.pixl_to_symbol.autotvout_data_out_V_last_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_data_in_V_data_V = 489;
parameter LENGTH_data_in_V_keep_V = 489;
parameter LENGTH_data_in_V_strb_V = 489;
parameter LENGTH_data_in_V_last_V = 489;
parameter LENGTH_data_out_V_data_V = 965;
parameter LENGTH_data_out_V_keep_V = 965;
parameter LENGTH_data_out_V_strb_V = 965;
parameter LENGTH_data_out_V_last_V = 965;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.pixl_to_symbol.autotvout_data_out_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pixl_to_symbol.autotvout_data_out_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pixl_to_symbol.autotvout_data_out_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pixl_to_symbol.autotvout_data_out_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.pixl_to_symbol.autotvout_data_out_V_data_V.dat with impl_rtl.pixl_to_symbol.autotvout_data_out_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pixl_to_symbol.autotvout_data_out_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pixl_to_symbol.autotvout_data_out_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pixl_to_symbol.autotvout_data_out_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pixl_to_symbol.autotvout_data_out_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.pixl_to_symbol.autotvout_data_out_V_keep_V.dat with impl_rtl.pixl_to_symbol.autotvout_data_out_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pixl_to_symbol.autotvout_data_out_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pixl_to_symbol.autotvout_data_out_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pixl_to_symbol.autotvout_data_out_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pixl_to_symbol.autotvout_data_out_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.pixl_to_symbol.autotvout_data_out_V_strb_V.dat with impl_rtl.pixl_to_symbol.autotvout_data_out_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pixl_to_symbol.autotvout_data_out_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pixl_to_symbol.autotvout_data_out_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pixl_to_symbol.autotvout_data_out_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pixl_to_symbol.autotvout_data_out_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.pixl_to_symbol.autotvout_data_out_V_last_V.dat with impl_rtl.pixl_to_symbol.autotvout_data_out_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
