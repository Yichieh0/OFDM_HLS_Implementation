...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pixl_to_symbol.autotvin.dat"
	set constFileTvOut       "pixl_to_symbol.autotvout.dat"
	set constFileHdlTvIn     "pixl_to_symbol.autohdltvin.dat"
	set constFileHdlTvOut    "pixl_to_symbol.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
