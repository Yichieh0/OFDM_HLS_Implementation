...
if {[file isfile pixl_to_symbol.autotvin.dat]} {
	file delete -force pixl_to_symbol.autotvin.dat
}

if {[file isfile pixl_to_symbol.autotvout.dat]} {
	file delete -force pixl_to_symbol.autotvout.dat
}
