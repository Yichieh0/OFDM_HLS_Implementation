...
module QAM_QAM_Pipeline_VITIS_LOOP_70_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [2:0] select_ln30_1_cast_fu_278_p3;
...
wire   [31:0] select_ln111_fu_250_p3;
wire   [61:0] trunc_ln_fu_291_p4;
wire   [31:0] select_ln29_1_cast_fu_327_p3;
reg   [31:0] out_temp_imag_V_fu_116;
wire   [31:0] select_ln1049_fu_226_p3;
wire  signed [31:0] sext_ln30_fu_287_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln70_fu_206_p2 == 1'd1) & (ap_start_int == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((((qam_num_2_reload_read_read_fu_120_p2 == 32'd16) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln70_fu_206_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln_fu_291_p4 == 62'd0)) | ((qam_num_2_reload_read_read_fu_120_p2 == 32'd16) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln70_fu_206_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln_fu_291_p4 == 62'd1)) | (~(trunc_ln_fu_291_p4 == 62'd0) & ~(trunc_ln_fu_291_p4 == 62'd1) & (qam_num_2_reload_read_read_fu_120_p2 == 32'd16) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln70_fu_206_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        out_temp_imag_V_fu_116 <= sext_ln30_fu_287_p1;
    end else if (((qam_num_2_reload_read_read_fu_120_p2 == 32'd4) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln70_fu_206_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_131)) begin
        if ((1'b1 == ap_condition_297)) begin
                        out_temp_real_V_fu_112[31 : 1] <= select_ln29_1_cast_fu_327_p3[31 : 1];
            ...
            out_temp_real_V_fu_112[31] <= 1'b1;
                        ...
                        out_temp_real_V_fu_112[31 : 1] <= select_ln111_fu_250_p3[31 : 1];
        end
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln70_fu_206_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((qam_num_2_reload_read_read_fu_120_p2 == 32'd16) & (icmp_ln70_fu_206_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln70_fu_206_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln70_fu_206_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        data_in_TREADY = 1'b1;
    end else begin
        data_in_TREADY = 1'b0;
    end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((data_out_TREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln70_fu_206_p2 == 1'd1) & (data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((data_out_TREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln70_fu_206_p2 == 1'd1) & (data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((data_out_TREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln70_fu_206_p2 == 1'd1) & (data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((icmp_ln70_fu_206_p2 == 1'd1) & (data_in_TVALID == 1'b0));
end
...
always @ (*) begin
    ap_condition_131 = ((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln70_fu_206_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign icmp_ln70_fu_206_p2 = (($signed(k_cast_fu_202_p1) < $signed(mul)) ? 1'b1 : 1'b0);
...
assign select_ln111_fu_250_p3 = ((icmp_ln1049_fu_244_p2[0:0] == 1'b1) ? 32'd4294967295 : 32'd1);

assign select_ln29_1_cast_fu_327_p3 = ((icmp_ln1049_2_fu_321_p2[0:0] == 1'b1) ? 32'd3 : 32'd1);

assign select_ln30_1_cast_fu_278_p3 = ((icmp_ln1049_1_fu_272_p2[0:0] == 1'b1) ? 3'd3 : 3'd1);

assign sext_ln30_fu_287_p1 = $signed(ap_phi_mux_out_temp_imag_V_1_phi_fu_184_p6);
...
endmodule //QAM_QAM_Pipeline_VITIS_LOOP_70_2
