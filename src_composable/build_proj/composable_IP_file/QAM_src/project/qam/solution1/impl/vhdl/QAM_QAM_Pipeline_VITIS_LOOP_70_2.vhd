...
entity QAM_QAM_Pipeline_VITIS_LOOP_70_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of QAM_QAM_Pipeline_VITIS_LOOP_70_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln70_fu_206_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln30_1_cast_fu_278_p3 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal select_ln111_fu_250_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln_fu_291_p4 : STD_LOGIC_VECTOR (61 downto 0);
    signal select_ln29_1_cast_fu_327_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal out_temp_imag_V_fu_116 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln1049_fu_226_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln30_fu_287_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((qam_num_2_reload_read_read_fu_120_p2 = ap_const_lv32_10) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (trunc_ln_fu_291_p4 = ap_const_lv62_0)) or ((qam_num_2_reload_read_read_fu_120_p2 = ap_const_lv32_10) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (trunc_ln_fu_291_p4 = ap_const_lv62_1)) or (not((trunc_ln_fu_291_p4 = ap_const_lv62_0)) and not((trunc_ln_fu_291_p4 = ap_const_lv62_1)) and (qam_num_2_reload_read_read_fu_120_p2 = ap_const_lv32_10) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
                out_temp_imag_V_fu_116 <= sext_ln30_fu_287_p1;
            elsif (((qam_num_2_reload_read_read_fu_120_p2 = ap_const_lv32_4) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_131)) then
                if ((ap_const_boolean_1 = ap_condition_297)) then 
                                        out_temp_real_V_fu_112(31 downto 1) <= select_ln29_1_cast_fu_327_p3(31 downto 1);
                    ...
                    out_temp_real_V_fu_112(31) <= '1';
                                        ...
                                        out_temp_real_V_fu_112(31 downto 1) <= select_ln111_fu_250_p3(31 downto 1);
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, data_in_TVALID, icmp_ln70_fu_206_p2, data_out_TREADY, ap_start_int)
    begin
                ap_block_pp0_stage0_01001 <= (((data_out_TREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (data_in_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, data_in_TVALID, icmp_ln70_fu_206_p2, data_out_TREADY, ap_start_int)
    begin
                ap_block_pp0_stage0_11001 <= (((data_out_TREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (data_in_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, data_in_TVALID, icmp_ln70_fu_206_p2, data_out_TREADY, ap_start_int)
    begin
                ap_block_pp0_stage0_subdone <= (((data_out_TREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (data_in_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(data_in_TVALID, icmp_ln70_fu_206_p2)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (data_in_TVALID = ap_const_logic_0));
    end process;
    ...
    ap_condition_131_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln70_fu_206_p2, ap_block_pp0_stage0_11001, ap_start_int)
    begin
                ap_condition_131 <= ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln70_fu_206_p2, ap_block_pp0_stage0_subdone, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (icmp_ln70_fu_206_p2 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_phi_mux_out_temp_imag_V_1_phi_fu_184_p6_assign_proc : process(icmp_ln70_fu_206_p2, qam_num_2_reload_read_read_fu_120_p2, ret_fu_268_p1, select_ln30_1_cast_fu_278_p3, ap_phi_reg_pp0_iter0_out_temp_imag_V_1_reg_181)
    begin
        if (((qam_num_2_reload_read_read_fu_120_p2 = ap_const_lv32_10) and (icmp_ln70_fu_206_p2 = ap_const_lv1_1))) then
            if ((ret_fu_268_p1 = ap_const_lv2_1)) then 
                ...
                ap_phi_mux_out_temp_imag_V_1_phi_fu_184_p6 <= select_ln30_1_cast_fu_278_p3;
            else 
    ...
    data_in_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, data_in_TVALID, icmp_ln70_fu_206_p2, ap_block_pp0_stage0, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    data_in_TREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln70_fu_206_p2, ap_block_pp0_stage0_11001, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln70_fu_206_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln70_fu_206_p2 <= "1" when (signed(k_cast_fu_202_p1) < signed(mul)) else "0";
    ...
    select_ln111_fu_250_p3 <= 
        ap_const_lv32_FFFFFFFF when (icmp_ln1049_fu_244_p2(0) = '1') else 
        ap_const_lv32_1;
    select_ln29_1_cast_fu_327_p3 <= 
        ap_const_lv32_3 when (icmp_ln1049_2_fu_321_p2(0) = '1') else 
        ap_const_lv32_1;
    select_ln30_1_cast_fu_278_p3 <= 
        ap_const_lv3_3 when (icmp_ln1049_1_fu_272_p2(0) = '1') else 
        ap_const_lv3_1;
        sext_ln30_fu_287_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ap_phi_mux_out_temp_imag_V_1_phi_fu_184_p6),32));
