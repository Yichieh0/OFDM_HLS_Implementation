...
module deQAM_deQAM_Pipeline_VITIS_LOOP_92_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [19:0] read_in_imag_V_2;
input  [2:0] select_ln92;
...
wire  signed [3:0] select_ln92_cast_fu_108_p1;
reg  signed [3:0] select_ln92_cast_reg_265;
reg   [3:0] i_V_1_reg_270;
wire   [63:0] grp_fu_105_p1;
reg   [63:0] conv_i_i1_reg_281;
...
reg   [3:0] i_V_fu_56;
wire   [3:0] i_V_2_fu_216_p2;
wire    ap_loop_init;
reg   [3:0] ap_sig_allocacmp_i_V_1;
reg   [3:0] v_V_1_fu_60;
wire   [3:0] select_ln93_fu_208_p3;
...
wire   [18:0] shl_ln737_1_fu_181_p3;
...
assign add_ln70_fu_203_p2 = ($signed(v_V_1_fu_60) + $signed(select_ln92_cast_reg_265));
...
assign bitcast_ln1827_fu_134_p1 = conv_i_i1_reg_281;

assign grp_fu_105_p0 = ap_sig_allocacmp_i_V_1;

assign i_V_2_fu_216_p2 = (i_V_1_reg_270 + 4'd2);

assign icmp_ln1549_fu_192_p2 = (($signed(read_in_imag_V_2) < $signed(zext_ln1549_fu_188_p1)) ? 1'b1 : 1'b0);
...
assign select_ln92_cast_fu_108_p1 = $signed(select_ln92);

assign select_ln93_fu_208_p3 = ((xor_ln1549_fu_197_p2[0:0] == 1'b1) ? add_ln70_fu_203_p2 : v_V_1_fu_60);

assign shl_ln737_1_fu_181_p3 = {{i_V_1_reg_270}, {15'd0}};
...
assign zext_ln1549_fu_188_p1 = shl_ln737_1_fu_181_p3;

endmodule //deQAM_deQAM_Pipeline_VITIS_LOOP_92_4
