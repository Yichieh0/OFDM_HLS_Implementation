...
entity deQAM_deQAM_Pipeline_VITIS_LOOP_92_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of deQAM_deQAM_Pipeline_VITIS_LOOP_92_4 is 
...
attribute shreg_extract : string;
    ...
    signal select_ln92_cast_fu_108_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln92_cast_reg_265 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_V_1_reg_270 : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_fu_105_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal conv_i_i1_reg_281 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal shl_ln737_1_fu_181_p3 : STD_LOGIC_VECTOR (18 downto 0);
...
begin
    dcmp_64ns_64ns_1_2_no_dsp_1_U21 : component deQAM_dcmp_64ns_64ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
                ...
                v_V_1_fu_60 <= select_ln93_fu_208_p3;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                conv_i_i1_reg_281 <= grp_fu_105_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                i_V_1_reg_270 <= ap_sig_allocacmp_i_V_1;
                select_ln92_cast_reg_265 <= select_ln92_cast_fu_108_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln70_fu_203_p2 <= std_logic_vector(unsigned(v_V_1_fu_60) + unsigned(select_ln92_cast_reg_265));
    ...
    bitcast_ln1827_fu_134_p1 <= conv_i_i1_reg_281;
    grp_fu_105_p0 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_V_1),32));
    i_V_2_fu_216_p2 <= std_logic_vector(unsigned(i_V_1_reg_270) + unsigned(ap_const_lv4_2));
    icmp_ln1549_fu_192_p2 <= "1" when (signed(read_in_imag_V_2) < signed(zext_ln1549_fu_188_p1)) else "0";
    ...
    or_ln1827_fu_163_p2 <= (icmp_ln1827_reg_287 or icmp_ln1827_1_reg_292);
        ...
        select_ln92_cast_fu_108_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(select_ln92),4));

    select_ln93_fu_208_p3 <= 
        add_ln70_fu_203_p2 when (xor_ln1549_fu_197_p2(0) = '1') else 
        v_V_1_fu_60;
    shl_ln737_1_fu_181_p3 <= (i_V_1_reg_270 & ap_const_lv15_0);
    ...
    v_V_1_out_ap_vld_assign_proc : process(ap_CS_fsm_state4, and_ln1827_1_fu_172_p2)
    begin
        if (((ap_const_lv1_0 = and_ln1827_1_fu_172_p2) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    zext_ln1549_fu_188_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln737_1_fu_181_p3),20));
end behav;
