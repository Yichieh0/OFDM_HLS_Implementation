...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "QAM.autotvin.dat"
	set constFileTvOut       "QAM.autotvout.dat"
	set constFileHdlTvIn     "QAM.autohdltvin.dat"
	set constFileHdlTvOut    "QAM.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
