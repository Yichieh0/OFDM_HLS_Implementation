...
$(ObjDir)/deQAM.cpp_pre.cpp.tb.o : deQAM.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling deQAM.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/QAM.cpp_pre.cpp.tb.o : QAM.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling QAM.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
