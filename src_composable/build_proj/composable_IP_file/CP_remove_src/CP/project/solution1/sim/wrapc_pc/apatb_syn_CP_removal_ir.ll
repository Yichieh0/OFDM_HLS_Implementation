; ModuleID = '/mnt/HLSNAS/g110064539/CP_src/CP/project/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_syn_CP_removal_ir(%"class.hls::stream"* %data_in, %"class.hls::stream"* %data_out) local_unnamed_addr #0 {
entry:
...
declare void @apatb_syn_CP_removal_hw(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i64*, i8*, i8*, i1*, i1*, i1*, i1*)

define void @syn_CP_removal_hw_stub_wrapper(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i64*, i8*, i8*, i1*, i1*, i1*, i1*) #5 {
entry:
  ...
  call void @syn_CP_removal_hw_stub(%"class.hls::stream"* %14, %"class.hls::stream"* %15)
...
declare void @syn_CP_removal_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
