...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "syn_CP_removal.autotvin.dat"
	set constFileTvOut       "syn_CP_removal.autotvout.dat"
	set constFileHdlTvIn     "syn_CP_removal.autohdltvin.dat"
	set constFileHdlTvOut    "syn_CP_removal.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
