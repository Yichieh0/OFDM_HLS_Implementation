...
entity syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_211_9 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    out_temp_r_V_3_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    out_temp_r_V_3_out_ap_vld : OUT STD_LOGIC;
    out_temp_i_V_3_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    out_temp_i_V_3_out_ap_vld : OUT STD_LOGIC );
end;


architecture behav of syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_211_9 is 
...
attribute shreg_extract : string;
    ...
    signal sext_ln14_1_cast_fu_181_p1 : STD_LOGIC_VECTOR (32 downto 0);
    signal sext_ln14_1_cast_reg_309 : STD_LOGIC_VECTOR (32 downto 0);
    signal p_Val2_s_fu_74 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_11_fu_247_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal p_Val2_9_fu_78 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_s_fu_235_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_82 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln211_fu_218_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln211_cast_fu_185_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal trunc_ln1057_fu_209_p1 : STD_LOGIC_VECTOR (32 downto 0);
...
begin
    ...
    p_Val2_9_fu_78_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    add_ln211_fu_218_p2 <= std_logic_vector(unsigned(i_fu_82) + unsigned(ap_const_lv64_1));
    ...
    data_out_TDATA <= (p_Result_s_fu_235_p5 & p_Result_11_fu_247_p5);
    ...
    icmp_ln1057_fu_213_p2 <= "1" when (signed(trunc_ln1057_fu_209_p1) < signed(sext_ln14_1_cast_reg_309)) else "0";
    out_temp_i_V_3_out <= p_Val2_s_fu_74;

    out_temp_i_V_3_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln1057_fu_213_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1057_fu_213_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            out_temp_i_V_3_out_ap_vld <= ap_const_logic_1;
        else 
            out_temp_i_V_3_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    out_temp_r_V_3_out <= p_Val2_9_fu_78;

    out_temp_r_V_3_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln1057_fu_213_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1057_fu_213_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            out_temp_r_V_3_out_ap_vld <= ap_const_logic_1;
        else 
            out_temp_r_V_3_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    p_Result_11_fu_247_p5 <= (p_Val2_s_fu_74(31 downto 20) & data_temp_imag_V_q0);
    p_Result_s_fu_235_p5 <= (p_Val2_9_fu_78(31 downto 20) & data_temp_real_V_q0);
        sext_ln14_1_cast_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln14_1),33));

        sext_ln211_cast_fu_185_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln211),64));

    trunc_ln1057_fu_209_p1 <= i_fu_82(33 - 1 downto 0);
end behav;
