...
entity syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_217_10 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln217 : IN STD_LOGIC_VECTOR (31 downto 0);
    out_temp_r_V_3_reload : IN STD_LOGIC_VECTOR (31 downto 0);
    out_temp_i_V_3_reload : IN STD_LOGIC_VECTOR (31 downto 0);
    sext_ln14_2 : IN STD_LOGIC_VECTOR (32 downto 0);
    ...
    out_temp_r_V_9_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    out_temp_r_V_9_out_ap_vld : OUT STD_LOGIC;
    out_temp_i_V_9_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    out_temp_i_V_9_out_ap_vld : OUT STD_LOGIC );
end;


architecture behav of syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_217_10 is 
...
attribute shreg_extract : string;
    ...
    signal sext_ln14_2_cast_fu_181_p1 : STD_LOGIC_VECTOR (33 downto 0);
    signal sext_ln14_2_cast_reg_309 : STD_LOGIC_VECTOR (33 downto 0);
    signal p_Val2_s_fu_74 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_7_fu_247_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal p_Val2_4_fu_78 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_s_fu_235_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_82 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln217_fu_218_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln217_cast_fu_185_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    i_fu_82 <= sext_ln217_cast_fu_185_p1;
                elsif (((icmp_ln1057_fu_213_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    i_fu_82 <= add_ln217_fu_218_p2;
                end if;
            end if; 
        end if;
    end process;

    p_Val2_4_fu_78_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    p_Val2_4_fu_78 <= out_temp_r_V_3_reload;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    p_Val2_4_fu_78 <= p_Result_s_fu_235_p5;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    p_Val2_s_fu_74 <= out_temp_i_V_3_reload;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    p_Val2_s_fu_74 <= p_Result_7_fu_247_p5;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                sext_ln14_2_cast_reg_309 <= sext_ln14_2_cast_fu_181_p1;
            end if;
        end if;
    end process;
    ...
    add_ln217_fu_218_p2 <= std_logic_vector(unsigned(i_fu_82) + unsigned(ap_const_lv64_1));
    ...
    data_out_TDATA <= (p_Result_s_fu_235_p5 & p_Result_7_fu_247_p5);
    ...
    icmp_ln1057_fu_213_p2 <= "1" when (signed(trunc_ln1057_fu_209_p1) < signed(sext_ln14_2_cast_reg_309)) else "0";
    out_temp_i_V_9_out <= p_Val2_s_fu_74;

    out_temp_i_V_9_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln1057_fu_213_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1057_fu_213_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            out_temp_i_V_9_out_ap_vld <= ap_const_logic_1;
        else 
            out_temp_i_V_9_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    out_temp_r_V_9_out <= p_Val2_4_fu_78;

    out_temp_r_V_9_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln1057_fu_213_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1057_fu_213_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            out_temp_r_V_9_out_ap_vld <= ap_const_logic_1;
        else 
            out_temp_r_V_9_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    p_Result_7_fu_247_p5 <= (p_Val2_s_fu_74(31 downto 20) & data_temp_imag_V_q0);
    p_Result_s_fu_235_p5 <= (p_Val2_4_fu_78(31 downto 20) & data_temp_real_V_q0);
        sext_ln14_2_cast_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln14_2),34));

        sext_ln217_cast_fu_185_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln217),64));
