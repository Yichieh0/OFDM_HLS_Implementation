...
module syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_29_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] CP_length_6_out;
output   CP_length_6_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln52_reg_295 == 1'd1))) begin
        CP_length_6_out_ap_vld = 1'b1;
    end else begin
        CP_length_6_out_ap_vld = 1'b0;
    end
end
...
assign CP_length_6_out = CP_length_fu_102;
...
assign icmp_ln32_fu_197_p2 = ((p_Result_s_fu_187_p4 == 16'd7) ? 1'b1 : 1'b0);
...
endmodule //syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_29_1
