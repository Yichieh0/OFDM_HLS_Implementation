...
entity syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_211_10 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_211_10 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln211_fu_209_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal sext_ln99_4_cast_fu_181_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln99_4_cast_reg_305 : STD_LOGIC_VECTOR (63 downto 0);
    signal p_Val2_s_fu_74 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_s_fu_231_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal p_Val2_1_fu_78 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_3_fu_243_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_82 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln211_fu_214_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln99_cast_fu_185_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    i_fu_82 <= sext_ln99_cast_fu_185_p1;
                elsif (((icmp_ln211_fu_209_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    i_fu_82 <= add_ln211_fu_214_p2;
                end if;
            end if; 
        end if;
    end process;

    p_Val2_1_fu_78_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    p_Val2_1_fu_78 <= out_temp_i_V_6_reload;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    p_Val2_1_fu_78 <= p_Result_3_fu_243_p5;
                end if;
            end if; 
        end if;
    end process;

    p_Val2_s_fu_74_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    p_Val2_s_fu_74 <= out_temp_r_V_6_reload;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    p_Val2_s_fu_74 <= p_Result_s_fu_231_p5;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                sext_ln99_4_cast_reg_305 <= sext_ln99_4_cast_fu_181_p1;
            end if;
        end if;
    end process;
    ...
    add_ln211_fu_214_p2 <= std_logic_vector(unsigned(i_fu_82) + unsigned(ap_const_lv64_1));
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln211_fu_209_p2)
    begin
        if (((icmp_ln211_fu_209_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    data_out_TDATA <= (p_Result_s_fu_231_p5 & p_Result_3_fu_243_p5);
    ...
    icmp_ln211_fu_209_p2 <= "1" when (signed(i_fu_82) < signed(sext_ln99_4_cast_reg_305)) else "0";
    out_temp_i_V_7_out <= p_Val2_1_fu_78;

    out_temp_i_V_7_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln211_fu_209_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln211_fu_209_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            out_temp_i_V_7_out_ap_vld <= ap_const_logic_1;
        else 
            out_temp_i_V_7_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    out_temp_r_V_7_out <= p_Val2_s_fu_74;

    out_temp_r_V_7_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln211_fu_209_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln211_fu_209_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            out_temp_r_V_7_out_ap_vld <= ap_const_logic_1;
        else 
            out_temp_r_V_7_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    p_Result_3_fu_243_p5 <= (p_Val2_1_fu_78(31 downto 20) & data_temp_imag_V_q0);
    p_Result_s_fu_231_p5 <= (p_Val2_s_fu_74(31 downto 20) & data_temp_real_V_q0);
        sext_ln99_4_cast_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln99_4),64));

        sext_ln99_cast_fu_185_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln99),64));
