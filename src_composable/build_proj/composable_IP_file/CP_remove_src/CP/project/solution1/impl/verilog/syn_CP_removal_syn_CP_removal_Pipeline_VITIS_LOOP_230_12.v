...
module syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_230_12 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        data_out_TDEST,
        out_temp_r_V_10_out,
        out_temp_r_V_10_out_ap_vld,
        out_temp_i_V_10_out,
        out_temp_i_V_10_out_ap_vld
);
...
output  [31:0] out_temp_r_V_10_out;
output   out_temp_r_V_10_out_ap_vld;
output  [31:0] out_temp_i_V_10_out;
output   out_temp_i_V_10_out_ap_vld;

reg ap_idle;
reg data_temp_real_V_ce0;
reg data_temp_imag_V_ce0;
reg data_out_TVALID;
reg out_temp_r_V_10_out_ap_vld;
reg out_temp_i_V_10_out_ap_vld;
...
wire  signed [33:0] sext_ln14_cast_fu_181_p1;
reg  signed [33:0] sext_ln14_cast_reg_309;
reg   [31:0] p_Val2_1_fu_74;
wire   [31:0] p_Result_3_fu_247_p5;
wire    ap_loop_init;
reg   [31:0] p_Val2_2_fu_78;
wire   [31:0] p_Result_s_fu_235_p5;
reg   [63:0] i_fu_82;
wire   [63:0] add_ln230_fu_218_p2;
wire  signed [63:0] sext_ln230_cast_fu_185_p1;
...
always @ (*) begin
    if (((icmp_ln1057_fu_213_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        out_temp_i_V_10_out_ap_vld = 1'b1;
    end else begin
        out_temp_i_V_10_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln1057_fu_213_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        out_temp_r_V_10_out_ap_vld = 1'b1;
    end else begin
        out_temp_r_V_10_out_ap_vld = 1'b0;
    end
end
...
assign add_ln230_fu_218_p2 = (i_fu_82 + 64'd1);
...
assign data_out_TDATA = {{p_Result_s_fu_235_p5}, {p_Result_3_fu_247_p5}};
...
assign icmp_ln1057_fu_213_p2 = (($signed(trunc_ln1057_fu_209_p1) < $signed(sext_ln14_cast_reg_309)) ? 1'b1 : 1'b0);

assign out_temp_i_V_10_out = p_Val2_1_fu_74;

assign out_temp_r_V_10_out = p_Val2_2_fu_78;

assign p_Result_3_fu_247_p5 = {{p_Val2_1_fu_74[31:20]}, {data_temp_imag_V_q0}};

assign p_Result_s_fu_235_p5 = {{p_Val2_2_fu_78[31:20]}, {data_temp_real_V_q0}};

assign sext_ln14_cast_fu_181_p1 = $signed(sext_ln14);

assign sext_ln230_cast_fu_185_p1 = $signed(sext_ln230);

assign trunc_ln1057_fu_209_p1 = i_fu_82[33:0];

endmodule //syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_230_12
