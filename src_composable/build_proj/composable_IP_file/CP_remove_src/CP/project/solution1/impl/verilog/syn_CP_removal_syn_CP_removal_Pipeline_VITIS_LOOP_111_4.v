...
module syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_111_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln111_fu_332_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln112_fu_366_p1;
reg   [6:0] phi_urem30_fu_78;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_phi_urem30_load_1;
reg   [6:0] ap_sig_allocacmp_phi_urem30_load;
wire   [6:0] idx_urem32_fu_401_p3;
reg   [13:0] phi_mul28_fu_82;
reg   [13:0] ap_sig_allocacmp_phi_mul28_load;
wire   [13:0] add_ln112_fu_350_p2;
reg   [6:0] i_4_fu_86;
reg   [6:0] ap_sig_allocacmp_i;
wire   [6:0] add_ln111_fu_338_p2;
wire   [1:0] trunc_ln4_fu_356_p4;
wire   [6:0] next_urem31_fu_389_p2;
wire   [0:0] empty_49_fu_395_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln111_fu_332_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln111_fu_332_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_phi_mul28_load = 14'd0;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_phi_urem30_load = 7'd0;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_phi_urem30_load_1 = 7'd0;
    end else begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln111_fu_332_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (trunc_ln4_fu_356_p4 == 2'd0))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln111_fu_332_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (trunc_ln4_fu_356_p4 == 2'd1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln111_fu_332_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (trunc_ln4_fu_356_p4 == 2'd2))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln111_fu_332_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (trunc_ln4_fu_356_p4 == 2'd3))) begin
...
assign add_ln111_fu_338_p2 = (ap_sig_allocacmp_i + 7'd1);

assign add_ln112_fu_350_p2 = (ap_sig_allocacmp_phi_mul28_load + 14'd205);
...
assign empty_49_fu_395_p2 = ((next_urem31_fu_389_p2 < 7'd20) ? 1'b1 : 1'b0);

assign icmp_ln111_fu_332_p2 = ((ap_sig_allocacmp_i == 7'd64) ? 1'b1 : 1'b0);

assign idx_urem32_fu_401_p3 = ((empty_49_fu_395_p2[0:0] == 1'b1) ? next_urem31_fu_389_p2 : 7'd0);

assign next_urem31_fu_389_p2 = (ap_sig_allocacmp_phi_urem30_load + 7'd1);

assign phi_imag_V_0_address0 = zext_ln112_fu_366_p1;

assign phi_imag_V_0_d0 = 27'd0;

assign phi_imag_V_1_address0 = zext_ln112_fu_366_p1;

assign phi_imag_V_1_d0 = 27'd0;

assign phi_imag_V_2_address0 = zext_ln112_fu_366_p1;

assign phi_imag_V_2_d0 = 27'd0;

assign phi_imag_V_3_address0 = zext_ln112_fu_366_p1;

assign phi_imag_V_3_d0 = 27'd0;

assign phi_real_V_0_address0 = zext_ln112_fu_366_p1;

assign phi_real_V_0_d0 = 27'd0;

assign phi_real_V_1_address0 = zext_ln112_fu_366_p1;

assign phi_real_V_1_d0 = 27'd0;

assign phi_real_V_2_address0 = zext_ln112_fu_366_p1;

assign phi_real_V_2_d0 = 27'd0;

assign phi_real_V_3_address0 = zext_ln112_fu_366_p1;

assign phi_real_V_3_d0 = 27'd0;

assign power_2_V_0_address0 = zext_ln112_fu_366_p1;

assign power_2_V_0_d0 = 27'd0;

assign power_2_V_1_address0 = zext_ln112_fu_366_p1;

assign power_2_V_1_d0 = 27'd0;

assign power_2_V_2_address0 = zext_ln112_fu_366_p1;

assign power_2_V_2_d0 = 27'd0;

assign power_2_V_3_address0 = zext_ln112_fu_366_p1;

assign power_2_V_3_d0 = 27'd0;

assign power_V_0_address0 = zext_ln112_fu_366_p1;

assign power_V_0_d0 = 27'd0;

assign power_V_1_address0 = zext_ln112_fu_366_p1;

assign power_V_1_d0 = 27'd0;

assign power_V_2_address0 = zext_ln112_fu_366_p1;

assign power_V_2_d0 = 27'd0;

assign power_V_3_address0 = zext_ln112_fu_366_p1;

assign power_V_3_d0 = 27'd0;

assign trunc_ln4_fu_356_p4 = {{ap_sig_allocacmp_phi_mul28_load[13:12]}};

assign zext_ln112_fu_366_p1 = ap_sig_allocacmp_phi_urem30_load_1;

endmodule //syn_CP_removal_syn_CP_removal_Pipeline_VITIS_LOOP_111_4
