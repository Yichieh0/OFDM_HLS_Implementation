...
module encoder_hls_deadlock_idx0_monitor ( // for module encoder_encoder_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 encoder_hls_deadlock_idx1_monitor encoder_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 encoder_hls_deadlock_idx2_monitor encoder_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
