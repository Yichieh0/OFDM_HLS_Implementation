set moduleName encoder_Pipeline_VITIS_LOOP_22_1
set isTopModule 0
...
set C_modelName {encoder_Pipeline_VITIS_LOOP_22_1}
...
set C_modelArgList {
	...
	{ DATA_LEN_1_out int 30 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data_in_V_data_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "DATA_LEN_1_out", "interface" : "wire", "bitwidth" : 30, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ DATA_LEN_1_out sc_out sc_lv 30 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "DATA_LEN_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "DATA_LEN_1_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	DATA_LEN_1_out { ap_vld {  { DATA_LEN_1_out out_data 1 30 }  { DATA_LEN_1_out_ap_vld out_vld 1 1 } } }
}
