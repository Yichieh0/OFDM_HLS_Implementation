...
`define TV_IN_data_in_TDATA "./c.encoder.autotvin_data_in_V_data_V.dat"
`define INGRESS_STATUS_data_in_TDATA "./stream_ingress_status_data_in_V_data_V.dat"
`define TV_IN_data_in_TKEEP "./c.encoder.autotvin_data_in_V_keep_V.dat"
`define INGRESS_STATUS_data_in_TKEEP "./stream_ingress_status_data_in_V_keep_V.dat"
`define TV_IN_data_in_TSTRB "./c.encoder.autotvin_data_in_V_strb_V.dat"
`define INGRESS_STATUS_data_in_TSTRB "./stream_ingress_status_data_in_V_strb_V.dat"
`define TV_IN_data_in_TLAST "./c.encoder.autotvin_data_in_V_last_V.dat"
