...
`define AUTOTB_TVIN_data_in_V_data_V  "./c.encoder.autotvin_data_in_V_data_V.dat"
`define AUTOTB_TVIN_data_in_V_keep_V  "./c.encoder.autotvin_data_in_V_keep_V.dat"
`define AUTOTB_TVIN_data_in_V_strb_V  "./c.encoder.autotvin_data_in_V_strb_V.dat"
`define AUTOTB_TVIN_data_in_V_last_V  "./c.encoder.autotvin_data_in_V_last_V.dat"
`define AUTOTB_TVIN_data_out_V_data_V  "./c.encoder.autotvin_data_out_V_data_V.dat"
`define AUTOTB_TVIN_data_out_V_keep_V  "./c.encoder.autotvin_data_out_V_keep_V.dat"
`define AUTOTB_TVIN_data_out_V_strb_V  "./c.encoder.autotvin_data_out_V_strb_V.dat"
`define AUTOTB_TVIN_data_out_V_last_V  "./c.encoder.autotvin_data_out_V_last_V.dat"
`define AUTOTB_TVIN_data_in_V_data_V_out_wrapc  "./rtl.encoder.autotvin_data_in_V_data_V.dat"
`define AUTOTB_TVIN_data_in_V_keep_V_out_wrapc  "./rtl.encoder.autotvin_data_in_V_keep_V.dat"
`define AUTOTB_TVIN_data_in_V_strb_V_out_wrapc  "./rtl.encoder.autotvin_data_in_V_strb_V.dat"
`define AUTOTB_TVIN_data_in_V_last_V_out_wrapc  "./rtl.encoder.autotvin_data_in_V_last_V.dat"
`define AUTOTB_TVIN_data_out_V_data_V_out_wrapc  "./rtl.encoder.autotvin_data_out_V_data_V.dat"
`define AUTOTB_TVIN_data_out_V_keep_V_out_wrapc  "./rtl.encoder.autotvin_data_out_V_keep_V.dat"
`define AUTOTB_TVIN_data_out_V_strb_V_out_wrapc  "./rtl.encoder.autotvin_data_out_V_strb_V.dat"
`define AUTOTB_TVIN_data_out_V_last_V_out_wrapc  "./rtl.encoder.autotvin_data_out_V_last_V.dat"
`define AUTOTB_TVOUT_data_out_V_data_V  "./c.encoder.autotvout_data_out_V_data_V.dat"
`define AUTOTB_TVOUT_data_out_V_keep_V  "./c.encoder.autotvout_data_out_V_keep_V.dat"
`define AUTOTB_TVOUT_data_out_V_strb_V  "./c.encoder.autotvout_data_out_V_strb_V.dat"
`define AUTOTB_TVOUT_data_out_V_last_V  "./c.encoder.autotvout_data_out_V_last_V.dat"
`define AUTOTB_TVOUT_data_out_V_data_V_out_wrapc  "./impl_rtl.encoder.autotvout_data_out_V_data_V.dat"
`define AUTOTB_TVOUT_data_out_V_keep_V_out_wrapc  "./impl_rtl.encoder.autotvout_data_out_V_keep_V.dat"
`define AUTOTB_TVOUT_data_out_V_strb_V_out_wrapc  "./impl_rtl.encoder.autotvout_data_out_V_strb_V.dat"
`define AUTOTB_TVOUT_data_out_V_last_V_out_wrapc  "./impl_rtl.encoder.autotvout_data_out_V_last_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.encoder.autotvout_data_out_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.encoder.autotvout_data_out_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.encoder.autotvout_data_out_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.encoder.autotvout_data_out_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.encoder.autotvout_data_out_V_data_V.dat with impl_rtl.encoder.autotvout_data_out_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.encoder.autotvout_data_out_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.encoder.autotvout_data_out_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.encoder.autotvout_data_out_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.encoder.autotvout_data_out_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.encoder.autotvout_data_out_V_keep_V.dat with impl_rtl.encoder.autotvout_data_out_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.encoder.autotvout_data_out_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.encoder.autotvout_data_out_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.encoder.autotvout_data_out_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.encoder.autotvout_data_out_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.encoder.autotvout_data_out_V_strb_V.dat with impl_rtl.encoder.autotvout_data_out_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.encoder.autotvout_data_out_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.encoder.autotvout_data_out_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.encoder.autotvout_data_out_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.encoder.autotvout_data_out_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.encoder.autotvout_data_out_V_last_V.dat with impl_rtl.encoder.autotvout_data_out_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
