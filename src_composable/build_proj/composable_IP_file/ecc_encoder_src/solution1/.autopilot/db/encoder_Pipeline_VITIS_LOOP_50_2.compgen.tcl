...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_in_TREADY { O 1 bit } data_in_TLAST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_s_V_load \
    op interface \
    ports { s_V_load { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 20 \
    name part_set_i_i_lcssa276_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_part_set_i_i_lcssa276_out \
    op interface \
    ports { part_set_i_i_lcssa276_out { O 6 vector } part_set_i_i_lcssa276_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName encoder_flow_control_loop_pipe_sequential_init_U
set CompName encoder_flow_control_loop_pipe_sequential_init
