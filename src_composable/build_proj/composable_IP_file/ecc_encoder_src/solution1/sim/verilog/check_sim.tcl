...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.encoder.autotvin_data_in_V_data_V.dat"
         "c.encoder.autotvin_data_in_V_keep_V.dat"
         "c.encoder.autotvin_data_in_V_strb_V.dat"
         "c.encoder.autotvin_data_in_V_last_V.dat"
         "c.encoder.autotvin_data_out_V_data_V.dat"
         "c.encoder.autotvin_data_out_V_keep_V.dat"
         "c.encoder.autotvin_data_out_V_strb_V.dat"
         "c.encoder.autotvin_data_out_V_last_V.dat"
         "c.encoder.autotvout_data_out_V_data_V.dat"
         "c.encoder.autotvout_data_out_V_keep_V.dat"
         "c.encoder.autotvout_data_out_V_strb_V.dat"
         "c.encoder.autotvout_data_out_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.encoder.autotvout_data_out_V_data_V.dat"
         "rtl.encoder.autotvout_data_out_V_keep_V.dat"
         "rtl.encoder.autotvout_data_out_V_strb_V.dat"
         "rtl.encoder.autotvout_data_out_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
