...
`define TV_OUT_data_out_TDATA "../tv/rtldatafile/rtl.encoder.autotvout_data_out_V_data_V.dat"
`define EGRESS_STATUS_data_out_TDATA "../tv/stream_size/stream_egress_status_data_out_V_data_V.dat"
`define TV_OUT_data_out_TKEEP "../tv/rtldatafile/rtl.encoder.autotvout_data_out_V_keep_V.dat"
`define EGRESS_STATUS_data_out_TKEEP "../tv/stream_size/stream_egress_status_data_out_V_keep_V.dat"
`define TV_OUT_data_out_TSTRB "../tv/rtldatafile/rtl.encoder.autotvout_data_out_V_strb_V.dat"
`define EGRESS_STATUS_data_out_TSTRB "../tv/stream_size/stream_egress_status_data_out_V_strb_V.dat"
`define TV_OUT_data_out_TLAST "../tv/rtldatafile/rtl.encoder.autotvout_data_out_V_last_V.dat"
...
module AESL_axi_s_data_out (
    ...
    fifo #(1925, 64) fifo_data_out_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1925, 8) fifo_data_out_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1925, 8) fifo_data_out_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1925, 1) fifo_data_out_TLAST (
        .reset(1'b0),
        .write_clock(clk),
