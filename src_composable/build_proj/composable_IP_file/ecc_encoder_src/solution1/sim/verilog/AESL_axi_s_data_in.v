...
`define TV_IN_data_in_TDATA "../tv/cdatafile/c.encoder.autotvin_data_in_V_data_V.dat"
`define INGRESS_STATUS_data_in_TDATA "../tv/stream_size/stream_ingress_status_data_in_V_data_V.dat"
`define TV_IN_data_in_TKEEP "../tv/cdatafile/c.encoder.autotvin_data_in_V_keep_V.dat"
`define INGRESS_STATUS_data_in_TKEEP "../tv/stream_size/stream_ingress_status_data_in_V_keep_V.dat"
`define TV_IN_data_in_TSTRB "../tv/cdatafile/c.encoder.autotvin_data_in_V_strb_V.dat"
`define INGRESS_STATUS_data_in_TSTRB "../tv/stream_size/stream_ingress_status_data_in_V_strb_V.dat"
`define TV_IN_data_in_TLAST "../tv/cdatafile/c.encoder.autotvin_data_in_V_last_V.dat"
...
module AESL_axi_s_data_in (
    ...
    fifo #(969, 64) fifo_data_in_TDATA (
        .reset(1'b0),
        .write_clock(clk),
