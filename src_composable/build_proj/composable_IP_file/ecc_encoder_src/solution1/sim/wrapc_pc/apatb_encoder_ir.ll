; ModuleID = '/mnt/HLSNAS/g110064539/composable_IP_file/ecc_encoder_src/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_encoder_ir(%"class.hls::stream"* %data_in, %"class.hls::stream"* %data_out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_encoder_hw(i64* %data_in_copy.data, i8* %data_in_copy.keep, i8* %data_in_copy.strb, i1* %data_in_copy.last, i64* %data_out_copy.data, i8* %data_out_copy.keep, i8* %data_out_copy.strb, i1* %data_out_copy.last)
...
declare void @apatb_encoder_hw(i64*, i8*, i8*, i1*, i64*, i8*, i8*, i1*)

define void @encoder_hw_stub_wrapper(i64*, i8*, i8*, i1*, i64*, i8*, i8*, i1*) #5 {
entry:
  ...
  call void @encoder_hw_stub(%"class.hls::stream"* %8, %"class.hls::stream"* %9)
  call void @copy_in(%"class.hls::stream"* %8, i64* %0, i8* %1, i8* %2, i1* %3, %"class.hls::stream"* %9, i64* %4, i8* %5, i8* %6, i1* %7)
  ret void
}

declare void @encoder_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
