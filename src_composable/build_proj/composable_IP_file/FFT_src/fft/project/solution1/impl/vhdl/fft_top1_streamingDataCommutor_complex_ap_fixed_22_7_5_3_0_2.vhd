...
entity fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_2 is 
...
attribute shreg_extract : string;
    ...
    signal delay_line_stall_8_load_reg_543 : STD_LOGIC_VECTOR (0 downto 0);
    signal delay_line_stall_8_load_reg_543_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal pf_count_V_6 : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal sample_in_read_count_V_8 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
    ...
    signal delayline_Array_8_q0 : STD_LOGIC_VECTOR (44 downto 0);
    ...
    signal delayline_Array_7_q0 : STD_LOGIC_VECTOR (44 downto 0);
    ...
    signal delay_line_stall_8_load_load_fu_229_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln79_11_fu_447_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal select_ln79_11_reg_579 : STD_LOGIC_VECTOR (21 downto 0);
    ...
    signal add_ln870_fu_287_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln870_4_fu_321_p2 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal p_7_fu_463_p4 : STD_LOGIC_VECTOR (44 downto 0);
    ...
    signal select_ln68_12_fu_427_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln68_11_fu_419_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal select_ln68_fu_411_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal select_ln79_12_fu_455_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_2_delayline_Array_8 IS
    generic (
        DataWidth : INTEGER;
...
begin
    delayline_Array_8_U : component fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_2_delayline_Array_8
    generic map (
        DataWidth => 45,
        AddressRange => 4,
        AddressWidth => 2)
    ...
    control_delayline_Array_8_U : component fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_2_control_delayline_Array_8
    generic map (
        DataWidth => 32,
        AddressRange => 4,
        AddressWidth => 2)
    ...
    delayline_Array_7_U : component fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_2_delayline_Array_8
    generic map (
        DataWidth => 45,
        AddressRange => 4,
        AddressWidth => 2)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_84)) then
                if (((fifo_has_next_sample_nbreadreq_fu_116_p3 = ap_const_lv1_0) and (delay_line_stall_8_load_load_fu_229_p1 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_8_load_reg_543 = ap_const_lv1_0)))) then
                and_ln297_reg_594 <= and_ln297_fu_505_p2;
                lshr_ln130_s_reg_589 <= delayline_Array_7_q0(43 downto 22);
                select_ln79_11_reg_579 <= select_ln79_11_fu_447_p3;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (fifo_has_next_sample_nbreadreq_fu_116_p3 = ap_const_lv1_1) and (real_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                delay_line_stall_8 <= icmp_ln256_fu_327_p2;
                sample_in_read_count_V_8 <= add_ln870_4_fu_321_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (fifo_has_next_sample_nbreadreq_fu_116_p3 = ap_const_lv1_1) and (real_start = ap_const_logic_1) and (icmp_ln1049_fu_281_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                control_count_V_8 <= xor_ln251_fu_305_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (fifo_has_next_sample_nbreadreq_fu_116_p3 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                delay_line_stall_8_load_reg_543 <= delay_line_stall_8;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                delay_line_stall_8_load_reg_543_pp0_iter1_reg <= delay_line_stall_8_load_reg_543;
    ...
    add_ln870_4_fu_321_p2 <= std_logic_vector(unsigned(sample_in_read_count_V_8) + unsigned(ap_const_lv5_1));
    add_ln870_fu_287_p2 <= std_logic_vector(unsigned(pf_count_V_6) + unsigned(ap_const_lv2_1));
    and_ln297_fu_505_p2 <= (valid_flag_fu_497_p3 and select_ln79_12_fu_455_p3);
    ...
    ap_predicate_op79_write_state4_assign_proc : process(delay_line_stall_8_load_reg_543_pp0_iter1_reg, and_ln297_reg_594, fifo_has_next_sample_reg_534_pp0_iter1_reg)
    begin
                ap_predicate_op79_write_state4 <= (((fifo_has_next_sample_reg_534_pp0_iter1_reg = ap_const_lv1_1) and (ap_const_lv1_1 = and_ln297_reg_594)) or ((delay_line_stall_8_load_reg_543_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_lv1_1 = and_ln297_reg_594)));
    end process;
    ...
    control_delayline_Array_8_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_8_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_8_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    control_delayline_Array_8_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_8_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_8_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    delay_line_stall_8_load_load_fu_229_p1 <= delay_line_stall_8;

    delayline_Array_7_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_8_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_8_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    delayline_Array_7_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_8_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_8_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    delayline_Array_8_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_8_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_8_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    delayline_Array_8_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_8_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_8_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    icmp_ln1049_fu_281_p2 <= "1" when (pf_count_V_6 = ap_const_lv2_3) else "0";
    icmp_ln231_fu_345_p2 <= "1" when (ap_phi_mux_t17_phi_fu_156_p6 = ap_const_lv6_27) else "0";
    icmp_ln256_fu_327_p2 <= "0" when (sample_in_read_count_V_8 = ap_const_lv5_1F) else "1";
    ...
    p_7_fu_463_p4 <= ((select_ln68_12_fu_427_p3 & select_ln68_11_fu_419_p3) & select_ln68_fu_411_p3);
    ...
    select_ln68_11_fu_419_p3 <= 
        temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_375_p4 when (control_bits_V_8(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_212;
    select_ln68_12_fu_427_p3 <= 
        temp_tagged_mux_chain_input_valid_1_fu_385_p3 when (control_bits_V_8(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_0_reg_188;
    select_ln68_fu_411_p3 <= 
        temp_tagged_mux_chain_input_sample_M_real_V_1_fu_371_p1 when (control_bits_V_8(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_V_0_reg_201;
    select_ln79_11_fu_447_p3 <= 
        temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_375_p4 when (trunc_ln79_fu_435_p1(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_212;
    select_ln79_12_fu_455_p3 <= 
    ...
    temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_375_p4 <= delayline_Array_8_q0(43 downto 22);
    temp_tagged_mux_chain_input_sample_M_real_V_1_fu_371_p1 <= delayline_Array_8_q0(22 - 1 downto 0);
    temp_tagged_mux_chain_input_valid_1_fu_385_p3 <= delayline_Array_8_q0(44 downto 44);
    tmp_fu_514_p7 <= (((((select_ln79_11_reg_579 & ap_const_lv10_0) & select_ln79_reg_574) & zext_ln174_fu_511_p1) & ap_const_lv10_0) & trunc_ln130_reg_584);
    trunc_ln130_fu_483_p1 <= delayline_Array_7_q0(22 - 1 downto 0);
    trunc_ln145_fu_233_p1 <= temp_dout(22 - 1 downto 0);
    trunc_ln79_fu_435_p1 <= control_delayline_Array_8_q0(1 - 1 downto 0);
    valid_flag_fu_497_p3 <= delayline_Array_7_q0(44 downto 44);
    xor_ln251_fu_305_p2 <= (control_count_V_8 xor ap_const_lv1_1);
    zext_ln174_fu_511_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln130_s_reg_589),32));
    zext_ln66_fu_397_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(control_bits_V_8),32));
end behav;
