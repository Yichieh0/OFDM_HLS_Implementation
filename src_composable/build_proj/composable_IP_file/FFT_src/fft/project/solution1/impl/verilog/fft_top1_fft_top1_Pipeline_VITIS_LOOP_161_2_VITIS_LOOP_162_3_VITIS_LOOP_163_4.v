...
module fft_top1_fft_top1_Pipeline_VITIS_LOOP_161_2_VITIS_LOOP_162_3_VITIS_LOOP_163_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [1:0] i_fu_88;
wire   [1:0] add_ln163_fu_242_p2;
wire    ap_loop_init;
reg   [8:0] indvar_flatten_fu_92;
wire   [8:0] select_ln162_1_fu_254_p3;
reg   [38:0] indvar_flatten11_fu_96;
wire   [38:0] add_ln161_fu_167_p2;
reg    ap_block_pp0_stage0_01001;
wire   [0:0] icmp_ln162_fu_179_p2;
wire   [0:0] icmp_ln163_fu_191_p2;
wire   [0:0] xor_ln161_fu_185_p2;
wire   [0:0] and_ln161_fu_197_p2;
wire   [0:0] or_ln162_fu_203_p2;
wire   [1:0] select_ln162_fu_209_p3;
wire   [8:0] add_ln162_fu_248_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_88 <= 2'd0;
        end else if (((icmp_ln161_fu_162_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln161_fu_162_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln161_fu_162_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln161_fu_162_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln161_fu_162_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        data_in_TREADY = 1'b1;
    end else begin
        data_in_TREADY = 1'b0;
    end
...
assign add_ln161_fu_167_p2 = (indvar_flatten11_fu_96 + 39'd1);

assign add_ln162_fu_248_p2 = (indvar_flatten_fu_92 + 9'd1);

assign add_ln163_fu_242_p2 = (select_ln162_fu_209_p3 + 2'd1);

assign and_ln161_fu_197_p2 = (xor_ln161_fu_185_p2 & icmp_ln163_fu_191_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (((io_acc_block_signal_op58 == 1'b0) & (trunc_ln174_reg_319 == 1'd1)) | ((trunc_ln174_reg_319 == 1'd0) & (io_acc_block_signal_op56 == 1'b0)))) | ((icmp_ln161_fu_162_p2 == 1'd0) & (data_in_TVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (((io_acc_block_signal_op58 == 1'b0) & (trunc_ln174_reg_319 == 1'd1)) | ((trunc_ln174_reg_319 == 1'd0) & (io_acc_block_signal_op56 == 1'b0)))) | ((icmp_ln161_fu_162_p2 == 1'd0) & (data_in_TVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (((io_acc_block_signal_op58 == 1'b0) & (trunc_ln174_reg_319 == 1'd1)) | ((trunc_ln174_reg_319 == 1'd0) & (io_acc_block_signal_op56 == 1'b0)))) | ((icmp_ln161_fu_162_p2 == 1'd0) & (data_in_TVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln161_fu_162_p2 == 1'd0) & (data_in_TVALID == 1'b0));
end
...
assign icmp_ln161_fu_162_p2 = ((indvar_flatten11_fu_96 == zext_ln161) ? 1'b1 : 1'b0);

assign icmp_ln162_fu_179_p2 = ((indvar_flatten_fu_92 == 9'd128) ? 1'b1 : 1'b0);

assign icmp_ln163_fu_191_p2 = ((i_fu_88 == 2'd2) ? 1'b1 : 1'b0);
...
assign or_ln162_fu_203_p2 = (icmp_ln162_fu_179_p2 | and_ln161_fu_197_p2);
...
assign select_ln162_1_fu_254_p3 = ((icmp_ln162_fu_179_p2[0:0] == 1'b1) ? 9'd1 : add_ln162_fu_248_p2);

assign select_ln162_fu_209_p3 = ((or_ln162_fu_203_p2[0:0] == 1'b1) ? 2'd0 : i_fu_88);

assign trunc_ln174_fu_235_p1 = select_ln162_fu_209_p3[0:0];

assign xor_ln161_fu_185_p2 = (icmp_ln162_fu_179_p2 ^ 1'd1);

endmodule //fft_top1_fft_top1_Pipeline_VITIS_LOOP_161_2_VITIS_LOOP_162_3_VITIS_LOOP_163_4
