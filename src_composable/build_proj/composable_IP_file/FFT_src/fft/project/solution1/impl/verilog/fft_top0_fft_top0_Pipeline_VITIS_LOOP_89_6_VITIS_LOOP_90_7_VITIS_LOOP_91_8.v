...
module fft_top0_fft_top0_Pipeline_VITIS_LOOP_89_6_VITIS_LOOP_90_7_VITIS_LOOP_91_8 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] fft_out_real_V_fu_348_p5;
reg   [31:0] p_Val2_1_fu_100;
wire   [31:0] fft_out_imag_V_fu_360_p5;
reg   [1:0] i_fu_104;
wire   [1:0] add_ln91_fu_267_p2;
wire    ap_loop_init;
reg   [8:0] indvar_flatten18_fu_108;
wire   [8:0] select_ln90_fu_279_p3;
reg   [38:0] indvar_flatten34_fu_112;
wire   [38:0] add_ln89_fu_210_p2;
reg    ap_block_pp0_stage0_01001;
wire   [0:0] icmp_ln90_fu_222_p2;
wire   [0:0] icmp_ln91_fu_234_p2;
wire   [0:0] xor_ln33_fu_228_p2;
wire   [0:0] and_ln33_fu_240_p2;
wire   [0:0] or_ln33_fu_246_p2;
wire   [1:0] select_ln33_fu_252_p3;
wire   [8:0] add_ln90_fu_273_p2;
wire   [19:0] read_Tout0_in_r_V_fu_328_p4;
wire   [19:0] read_Tout0_in_i_V_fu_338_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_104 <= 2'd0;
        end else if (((icmp_ln89_fu_205_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln89_fu_205_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        trunc_ln145_reg_434 <= trunc_ln145_fu_260_p1;
    end
end

always @ (*) begin
    if (((icmp_ln89_fu_205_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln89_reg_430 == 1'd0)) begin
        if ((trunc_ln145_reg_434 == 1'd0)) begin
            ap_phi_mux_p_04_0_0_0_0_phi_fu_172_p4 = p_outData_V_M_real_V_0_dout;
        end else if ((trunc_ln145_reg_434 == 1'd1)) begin
...
assign add_ln89_fu_210_p2 = (indvar_flatten34_fu_112 + 39'd1);

assign add_ln90_fu_273_p2 = (indvar_flatten18_fu_108 + 9'd1);

assign add_ln91_fu_267_p2 = (select_ln33_fu_252_p3 + 2'd1);

assign and_ln33_fu_240_p2 = (xor_ln33_fu_228_p2 & icmp_ln91_fu_234_p2);
...
always @ (*) begin
    ap_predicate_op53_read_state3 = ((trunc_ln145_reg_434 == 1'd0) & (icmp_ln89_reg_430 == 1'd0));
end

always @ (*) begin
    ap_predicate_op57_read_state3 = ((trunc_ln145_reg_434 == 1'd1) & (icmp_ln89_reg_430 == 1'd0));
end

assign data_out_TDATA = {{fft_out_real_V_fu_348_p5}, {fft_out_imag_V_fu_360_p5}};
...
assign fft_out_imag_V_fu_360_p5 = {{p_Val2_1_fu_100[31:20]}, {read_Tout0_in_i_V_fu_338_p4}};

assign fft_out_real_V_fu_348_p5 = {{p_Val2_s_fu_96[31:20]}, {read_Tout0_in_r_V_fu_328_p4}};

assign icmp_ln89_fu_205_p2 = ((indvar_flatten34_fu_112 == zext_ln74) ? 1'b1 : 1'b0);

assign icmp_ln90_fu_222_p2 = ((indvar_flatten18_fu_108 == 9'd128) ? 1'b1 : 1'b0);

assign icmp_ln91_fu_234_p2 = ((i_fu_104 == 2'd2) ? 1'b1 : 1'b0);
...
assign or_ln33_fu_246_p2 = (icmp_ln90_fu_222_p2 | and_ln33_fu_240_p2);

assign read_Tout0_in_i_V_fu_338_p4 = {{ap_phi_mux_p_15_0_0_0_0_phi_fu_181_p4[25:6]}};

assign read_Tout0_in_r_V_fu_328_p4 = {{ap_phi_mux_p_04_0_0_0_0_phi_fu_172_p4[25:6]}};

assign select_ln33_fu_252_p3 = ((or_ln33_fu_246_p2[0:0] == 1'b1) ? 2'd0 : i_fu_104);

assign select_ln90_fu_279_p3 = ((icmp_ln90_fu_222_p2[0:0] == 1'b1) ? 9'd1 : add_ln90_fu_273_p2);

assign trunc_ln145_fu_260_p1 = select_ln33_fu_252_p3[0:0];

assign xor_ln33_fu_228_p2 = (icmp_ln90_fu_222_p2 ^ 1'd1);

endmodule //fft_top0_fft_top0_Pipeline_VITIS_LOOP_89_6_VITIS_LOOP_90_7_VITIS_LOOP_91_8
