...
entity fft_top1_writeBackCacheDataDR_128_2_ap_fixed_27_13_5_3_0_ap_fixed_27_13_5_3_0_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top1_writeBackCacheDataDR_128_2_ap_fixed_27_13_5_3_0_ap_fixed_27_13_5_3_0_s is 
...
attribute shreg_extract : string;
    ...
    signal r21_reg_142 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_2_fu_156_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2_reg_276 : STD_LOGIC_VECTOR (0 downto 0);
    signal r_fu_230_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal r_reg_304 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln319_reg_309 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_phi_mux_r21_phi_fu_146_p6 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_fu_176_p4 : STD_LOGIC_VECTOR (4 downto 0);
    signal out_r_fu_186_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal or_ln_fu_168_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal xor_ln150_fu_200_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_1_fu_206_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal out_r_1_fu_216_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tmp_2_reg_276 <= ap_phi_mux_r21_phi_fu_146_p6(5 downto 5);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_96)) then
            if ((icmp_ln319_reg_309 = ap_const_lv1_1)) then 
                ap_phi_mux_r21_phi_fu_146_p6 <= ap_const_lv6_0;
    ...
    icmp_ln319_fu_236_p2 <= "1" when (ap_phi_mux_r21_phi_fu_146_p6 = ap_const_lv6_3F) else "0";
    ...
    p_digitReseversedOutputBuff_M_imag2_address0 <= zext_ln344_1_fu_224_p1(6 - 1 downto 0);
    ...
    p_digitReseversedOutputBuff_M_imag_address0 <= zext_ln344_fu_194_p1(6 - 1 downto 0);
    ...
    p_digitReseversedOutputBuff_M_real1_address0 <= zext_ln344_1_fu_224_p1(6 - 1 downto 0);
    ...
    p_digitReseversedOutputBuff_M_real_address0 <= zext_ln344_fu_194_p1(6 - 1 downto 0);
    ...
    r_fu_230_p2 <= std_logic_vector(unsigned(ap_phi_mux_r21_phi_fu_146_p6) + unsigned(ap_const_lv6_1));
    ...
    begin
        ...
        if (vlo_cpy(3 - 1 downto 0) > vhi_cpy(3 - 1 downto 0)) then
            vhi_cpy(3-1 downto 0) := std_logic_vector(6-1-unsigned(ap_const_lv32_1(3-1 downto 0)));
            vlo_cpy(3-1 downto 0) := std_logic_vector(6-1-unsigned(ap_const_lv32_4(3-1 downto 0)));
            for tmp_1_fu_206_p4_i in 0 to 6-1 loop
                v0_cpy(tmp_1_fu_206_p4_i) := ap_phi_mux_r21_phi_fu_146_p6(6-1-tmp_1_fu_206_p4_i);
            end loop;
        end if;
        ...
        tmp_1_fu_206_p4 <= resvalue(4-1 downto 0);
    end process;

    tmp_2_fu_156_p3 <= ap_phi_mux_r21_phi_fu_146_p6(5 downto 5);
    ...
    begin
        ...
        if (vlo_cpy(3 - 1 downto 0) > vhi_cpy(3 - 1 downto 0)) then
            ...
            vlo_cpy(3-1 downto 0) := std_logic_vector(6-1-unsigned(ap_const_lv32_4(3-1 downto 0)));
            for tmp_fu_176_p4_i in 0 to 6-1 loop
                v0_cpy(tmp_fu_176_p4_i) := ap_phi_mux_r21_phi_fu_146_p6(6-1-tmp_fu_176_p4_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy), to_integer(unsigned('0' & vlo_cpy(3-1 downto 0)))));
        ...
        res_mask := res_mask(6-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        tmp_fu_176_p4 <= resvalue(5-1 downto 0);
    end process;
