...
entity fft_top1_convertSuperStreamToArrayNScale_1_0_50000_128_2_complex_ap_fixed_27_13_5_3_0_complex_ap_fixed_27_13_5_3_0_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top1_convertSuperStreamToArrayNScale_1_0_50000_128_2_complex_ap_fixed_27_13_5_3_0_complex_ap_fixed_27_13_5_3_0_s is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln222_fu_108_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_2_fu_114_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    component fft_top1_flow_control_loop_pipe IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_U : component fft_top1_flow_control_loop_pipe
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => real_start,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_117)) then
                if ((icmp_ln222_fu_108_p2 = ap_const_lv1_0)) then 
                    i_fu_70 <= i_2_fu_114_p2;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_done_reg, fftOutData_local_empty_n, io_acc_block_signal_op29, io_acc_block_signal_op30, ap_start_int)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((io_acc_block_signal_op30 = ap_const_logic_0) or (io_acc_block_signal_op29 = ap_const_logic_0) or (fftOutData_local_empty_n = ap_const_logic_0))) or ((ap_done_reg = ap_const_logic_1) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_done_reg, fftOutData_local_empty_n, io_acc_block_signal_op29, io_acc_block_signal_op30, ap_start_int)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((io_acc_block_signal_op30 = ap_const_logic_0) or (io_acc_block_signal_op29 = ap_const_logic_0) or (fftOutData_local_empty_n = ap_const_logic_0))) or ((ap_done_reg = ap_const_logic_1) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_done_reg, fftOutData_local_empty_n, io_acc_block_signal_op29, io_acc_block_signal_op30, ap_start_int)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((io_acc_block_signal_op30 = ap_const_logic_0) or (io_acc_block_signal_op29 = ap_const_logic_0) or (fftOutData_local_empty_n = ap_const_logic_0))) or ((ap_done_reg = ap_const_logic_1) and (ap_start_int = ap_const_logic_1)));
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(fftOutData_local_empty_n, io_acc_block_signal_op29, io_acc_block_signal_op30)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((io_acc_block_signal_op30 = ap_const_logic_0) or (io_acc_block_signal_op29 = ap_const_logic_0) or (fftOutData_local_empty_n = ap_const_logic_0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln222_fu_108_p2, ap_start_int)
    begin
        if (((icmp_ln222_fu_108_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    i_2_fu_114_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv7_1));
    icmp_ln222_fu_108_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv7_40) else "0";
    io_acc_block_signal_op29 <= (p_outDataArray_0_1_0_0_0_full_n and p_outDataArray_0_0_0_0_0_full_n);
    io_acc_block_signal_op30 <= (p_outDataArray_0_1_0_0_02_full_n and p_outDataArray_0_0_0_0_01_full_n);
    ...
    p_outDataArray_0_1_0_0_02_din <= fftOutData_local_dout(122 downto 96);
