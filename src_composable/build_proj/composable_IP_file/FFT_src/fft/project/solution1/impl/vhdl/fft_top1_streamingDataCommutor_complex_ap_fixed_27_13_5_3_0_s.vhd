...
entity fft_top1_streamingDataCommutor_complex_ap_fixed_27_13_5_3_0_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top1_streamingDataCommutor_complex_ap_fixed_27_13_5_3_0_s is 
...
attribute shreg_extract : string;
    ...
    component fft_top1_streamingDataCommutor_complex_ap_fixed_27_13_5_3_0_s_delayline_Array_14 IS
    generic (
        DataWidth : INTEGER;
...
begin
    delayline_Array_14_U : component fft_top1_streamingDataCommutor_complex_ap_fixed_27_13_5_3_0_s_delayline_Array_14
    generic map (
        DataWidth => 55,
        AddressRange => 1,
        AddressWidth => 1)
    ...
    control_delayline_Array_2_U : component fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_s_control_delayline_Array_4
    generic map (
        DataWidth => 32,
        AddressRange => 1,
        AddressWidth => 1)
    ...
    delayline_Array_2_U : component fft_top1_streamingDataCommutor_complex_ap_fixed_27_13_5_3_0_s_delayline_Array_14
    generic map (
        DataWidth => 55,
        AddressRange => 1,
        AddressWidth => 1)
