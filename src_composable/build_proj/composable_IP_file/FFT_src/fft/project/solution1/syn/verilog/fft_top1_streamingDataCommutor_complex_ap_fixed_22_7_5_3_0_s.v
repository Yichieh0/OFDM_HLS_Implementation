...
reg   [0:0] delay_line_stall_4_load_reg_507;
reg   [0:0] delay_line_stall_4_load_reg_507_pp0_iter1_reg;
...
reg   [0:0] control_count_V_4;
reg   [0:0] control_bits_V_4;
reg   [4:0] sample_in_read_count_V_4;
reg   [0:0] delay_line_stall_4;
reg    delayline_Array_18_ce0;
reg    delayline_Array_18_we0;
wire   [44:0] delayline_Array_18_q0;
reg    control_delayline_Array_4_ce0;
reg    control_delayline_Array_4_we0;
wire   [31:0] control_delayline_Array_4_q0;
reg    delayline_Array_17_ce0;
reg    delayline_Array_17_we0;
wire   [44:0] delayline_Array_17_q0;
...
reg   [5:0] t_reg_502;
wire   [0:0] delay_line_stall_4_load_load_fu_221_p1;
wire   [21:0] trunc_ln145_fu_225_p1;
reg   [0:0] icmp_ln231_reg_531;
reg   [0:0] icmp_ln231_reg_531_pp0_iter1_reg;
wire   [21:0] select_ln79_fu_403_p3;
reg   [21:0] select_ln79_reg_535;
wire   [21:0] select_ln79_3_fu_411_p3;
reg   [21:0] select_ln79_3_reg_540;
wire   [21:0] trunc_ln130_fu_447_p1;
reg   [21:0] trunc_ln130_reg_545;
reg   [21:0] lshr_ln130_5_reg_550;
wire   [0:0] and_ln297_fu_469_p2;
reg    ap_enable_reg_pp0_iter1;
reg    ap_block_state1;
reg    ap_block_pp0_stage0_subdone;
reg   [5:0] ap_phi_mux_t17_phi_fu_148_p6;
wire   [21:0] ap_phi_reg_pp0_iter0_arrayidx_0_01_load_0_i365_reg_158;
reg   [21:0] ap_phi_reg_pp0_iter1_arrayidx_0_01_load_0_i365_reg_158;
wire   [21:0] ap_phi_reg_pp0_iter0_arrayidx_0_11_load_0_i364_reg_169;
reg   [21:0] ap_phi_reg_pp0_iter1_arrayidx_0_11_load_0_i364_reg_169;
...
wire   [21:0] ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_real_V_0_reg_193;
reg   [21:0] ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_V_0_reg_193;
wire   [21:0] ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_204;
reg   [21:0] ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_204;
wire   [0:0] xor_ln251_fu_269_p2;
wire   [4:0] add_ln870_fu_285_p2;
wire   [0:0] icmp_ln256_fu_291_p2;
reg    ap_block_pp0_stage0_01001;
wire   [44:0] p_s_fu_315_p4;
wire   [31:0] zext_ln66_fu_361_p1;
wire   [44:0] p_5_fu_427_p4;
wire   [21:0] temp_tagged_mux_chain_input_sample_M_real_V_1_fu_335_p1;
wire   [21:0] temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_339_p4;
wire   [0:0] temp_tagged_mux_chain_input_valid_1_fu_349_p3;
wire   [0:0] trunc_ln79_fu_399_p1;
wire   [0:0] select_ln68_4_fu_391_p3;
wire   [21:0] select_ln68_3_fu_383_p3;
wire   [21:0] select_ln68_fu_375_p3;
wire   [0:0] select_ln79_4_fu_419_p3;
wire   [0:0] valid_flag_fu_461_p3;
wire   [31:0] zext_ln174_fu_475_p1;
wire   [117:0] tmp_fu_478_p7;
reg   [1:0] ap_NS_fsm;
...
#0 control_count_V_4 = 1'd0;
#0 control_bits_V_4 = 1'd0;
#0 sample_in_read_count_V_4 = 5'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_84)) begin
        if (((fifo_has_next_sample_nbreadreq_fu_108_p3 == 1'd0) & (delay_line_stall_4_load_load_fu_221_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_arrayidx_0_01_load_0_i365_reg_158 <= 22'd0;
        end else if ((fifo_has_next_sample_nbreadreq_fu_108_p3 == 1'd1)) begin
            ap_phi_reg_pp0_iter1_arrayidx_0_01_load_0_i365_reg_158 <= {{casted_output_dout[85:64]}};
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_84)) begin
        if (((fifo_has_next_sample_nbreadreq_fu_108_p3 == 1'd0) & (delay_line_stall_4_load_load_fu_221_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_arrayidx_0_11_load_0_i364_reg_169 <= 22'd0;
        end else if ((fifo_has_next_sample_nbreadreq_fu_108_p3 == 1'd1)) begin
            ap_phi_reg_pp0_iter1_arrayidx_0_11_load_0_i364_reg_169 <= {{casted_output_dout[117:96]}};
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_84)) begin
        if (((fifo_has_next_sample_nbreadreq_fu_108_p3 == 1'd0) & (delay_line_stall_4_load_load_fu_221_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_204 <= 22'd0;
        end else if ((fifo_has_next_sample_nbreadreq_fu_108_p3 == 1'd1)) begin
            ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_204 <= {{casted_output_dout[53:32]}};
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_84)) begin
        if (((fifo_has_next_sample_nbreadreq_fu_108_p3 == 1'd0) & (delay_line_stall_4_load_load_fu_221_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_V_0_reg_193 <= 22'd0;
        end else if ((fifo_has_next_sample_nbreadreq_fu_108_p3 == 1'd1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((fifo_has_next_sample_reg_498 == 1'd1) | (delay_line_stall_4_load_reg_507 == 1'd0)))) begin
        and_ln297_reg_555 <= and_ln297_fu_469_p2;
        lshr_ln130_5_reg_550 <= {{delayline_Array_17_q0[43:22]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_498 == 1'd1) | (delay_line_stall_4_load_reg_507 == 1'd0)))) begin
        control_delayline_Array_4_ce0 = 1'd1;
    end else begin
        control_delayline_Array_4_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_498 == 1'd1) | (delay_line_stall_4_load_reg_507 == 1'd0)))) begin
        control_delayline_Array_4_we0 = 1'd1;
    end else begin
        control_delayline_Array_4_we0 = 1'b0;
    end
end
...
assign add_ln870_fu_285_p2 = (sample_in_read_count_V_4 + 5'd1);
...
always @ (*) begin
    ap_predicate_op71_write_state4 = (((fifo_has_next_sample_reg_498_pp0_iter1_reg == 1'd1) & (1'd1 == and_ln297_reg_555)) | ((delay_line_stall_4_load_reg_507_pp0_iter1_reg == 1'd0) & (1'd1 == and_ln297_reg_555)));
end

assign ap_ready = internal_ap_ready;

assign delay_line_stall_4_load_load_fu_221_p1 = delay_line_stall_4;
...
assign icmp_ln256_fu_291_p2 = ((sample_in_read_count_V_4 != 5'd31) ? 1'b1 : 1'b0);
...
assign select_ln68_3_fu_383_p3 = ((control_bits_V_4[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_339_p4 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_204);

assign select_ln68_4_fu_391_p3 = ((control_bits_V_4[0:0] == 1'b1) ? temp_tagged_mux_chain_input_valid_1_fu_349_p3 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_0_reg_180);

assign select_ln68_fu_375_p3 = ((control_bits_V_4[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_real_V_1_fu_335_p1 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_V_0_reg_193);
...
assign temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_339_p4 = {{delayline_Array_18_q0[43:22]}};

assign temp_tagged_mux_chain_input_sample_M_real_V_1_fu_335_p1 = delayline_Array_18_q0[21:0];

assign temp_tagged_mux_chain_input_valid_1_fu_349_p3 = delayline_Array_18_q0[32'd44];

assign tmp_fu_478_p7 = {{{{{{select_ln79_3_reg_540}, {10'd0}}, {select_ln79_reg_535}}, {zext_ln174_fu_475_p1}}, {10'd0}}, {trunc_ln130_reg_545}};

assign trunc_ln130_fu_447_p1 = delayline_Array_17_q0[21:0];

assign trunc_ln145_fu_225_p1 = casted_output_dout[21:0];

assign trunc_ln79_fu_399_p1 = control_delayline_Array_4_q0[0:0];

assign valid_flag_fu_461_p3 = delayline_Array_17_q0[32'd44];

assign xor_ln251_fu_269_p2 = (control_count_V_4 ^ 1'd1);

assign zext_ln174_fu_475_p1 = lshr_ln130_5_reg_550;

assign zext_ln66_fu_361_p1 = control_bits_V_4;
