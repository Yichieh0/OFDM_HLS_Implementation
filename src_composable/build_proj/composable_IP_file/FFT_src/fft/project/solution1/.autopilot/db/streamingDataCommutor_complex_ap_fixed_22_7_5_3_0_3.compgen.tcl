...
set ID 35
set hasByteEnable 0
set MemName fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_3_delayline_Array_12
...
set ID 36
set hasByteEnable 0
set MemName fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_3_control_delayline_Array_1
set CoreName ShiftReg
set PortList { 2 }
set DataWd 32
set AddrRange 8
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_temp1 \
    op interface \
    ports { temp1_din { O 128 vector } temp1_full_n { I 1 bit } temp1_write { O 1 bit } } \
} "
}
