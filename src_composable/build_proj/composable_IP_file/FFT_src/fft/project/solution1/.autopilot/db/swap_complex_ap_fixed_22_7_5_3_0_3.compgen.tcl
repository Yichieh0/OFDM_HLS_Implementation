...
# FIFO definition: 
set ID 43
set FifoName fft_top1_fifo_w128_d8_D
set InstName temp_1_U
...
# FIFO definition: 
set ID 44
set FifoName fft_top1_start_for_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_4_U0
set InstName start_for_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_4_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_temp \
    op interface \
    ports { temp_dout { I 128 vector } temp_empty_n { I 1 bit } temp_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_fftInData_reOrdered_din { O 128 vector } p_fftInData_reOrdered_full_n { I 1 bit } p_fftInData_reOrdered_write { O 1 bit } } \
} "
}
