...
set ID 31
set hasByteEnable 0
set MemName fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_2_delayline_Array_8
...
set ID 32
set hasByteEnable 0
set MemName fft_top1_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_2_control_delayline_Array_8
set CoreName ShiftReg
set PortList { 2 }
set DataWd 32
set AddrRange 4
