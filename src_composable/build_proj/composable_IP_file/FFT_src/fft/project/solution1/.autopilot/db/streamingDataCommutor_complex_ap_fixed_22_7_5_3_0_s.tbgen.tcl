set moduleName streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_s
set isTopModule 0
...
set C_modelName {streamingDataCommutor<complex<ap_fixed<22, 7, 5, 3, 0> > >}
set C_modelType { void 0 }
set C_modelArgList {
	{ casted_output int 128 regular {fifo 0 volatile }  }
	{ temp int 128 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "casted_output", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "temp", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ temp_din sc_out sc_lv 128 signal 1 } 
	{ temp_full_n sc_in sc_logic 1 signal 1 } 
	{ temp_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "temp_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "temp", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "temp", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.delayline_Array_18_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.control_delayline_Array_4_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.delayline_Array_17_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	temp { ap_fifo {  { temp_din fifo_data 1 128 }  { temp_full_n fifo_status 0 1 }  { temp_write fifo_update 1 1 } } }
}
