...
unsigned int ap_apatb_data_in_V_user_V_V_cap_bc;
static AESL_RUNTIME_BC __xlx_data_in_V_user_V_V_size_Reader("../tv/stream_size/stream_size_in_data_in_V_user_V.dat");
...
unsigned int ap_apatb_data_in_V_id_V_V_cap_bc;
static AESL_RUNTIME_BC __xlx_data_in_V_id_V_V_size_Reader("../tv/stream_size/stream_size_in_data_in_V_id_V.dat");
unsigned int ap_apatb_data_in_V_dest_V_V_cap_bc;
static AESL_RUNTIME_BC __xlx_data_in_V_dest_V_V_size_Reader("../tv/stream_size/stream_size_in_data_in_V_dest_V.dat");
...
unsigned int ap_apatb_data_out_V_user_V_V_cap_bc;
static AESL_RUNTIME_BC __xlx_data_out_V_user_V_V_size_Reader("../tv/stream_size/stream_size_out_data_out_V_user_V.dat");
...
unsigned int ap_apatb_data_out_V_id_V_V_cap_bc;
static AESL_RUNTIME_BC __xlx_data_out_V_id_V_V_size_Reader("../tv/stream_size/stream_size_out_data_out_V_id_V.dat");
unsigned int ap_apatb_data_out_V_dest_V_V_cap_bc;
static AESL_RUNTIME_BC __xlx_data_out_V_dest_V_V_size_Reader("../tv/stream_size/stream_size_out_data_out_V_dest_V.dat");
extern "C" void equalizer_pilot_removal(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_equalizer_pilot_removal_hw(volatile void * __xlx_apatb_param_data_in_V_data_V, volatile void * __xlx_apatb_param_data_in_V_keep_V, volatile void * __xlx_apatb_param_data_in_V_strb_V, volatile void * __xlx_apatb_param_data_in_V_user_V, volatile void * __xlx_apatb_param_data_in_V_last_V, volatile void * __xlx_apatb_param_data_in_V_id_V, volatile void * __xlx_apatb_param_data_in_V_dest_V, volatile void * __xlx_apatb_param_data_out_V_data_V, volatile void * __xlx_apatb_param_data_out_V_keep_V, volatile void * __xlx_apatb_param_data_out_V_strb_V, volatile void * __xlx_apatb_param_data_out_V_user_V, volatile void * __xlx_apatb_param_data_out_V_last_V, volatile void * __xlx_apatb_param_data_out_V_id_V, volatile void * __xlx_apatb_param_data_out_V_dest_V) {
  ...
  // collect __xlx_data_in_V_user_V_tmp_vec
  unsigned __xlx_data_in_V_user_V_V_tmp_Count = 0;
  unsigned __xlx_data_in_V_user_V_V_read_Size = __xlx_data_in_V_user_V_V_size_Reader.read_size();
  vector<char> __xlx_data_in_V_user_V_tmp_vec;
  while (!((hls::stream<char>*)__xlx_apatb_param_data_in_V_user_V)->empty() && __xlx_data_in_V_user_V_V_tmp_Count < __xlx_data_in_V_user_V_V_read_Size) {
    __xlx_data_in_V_user_V_tmp_vec.push_back(((hls::stream<char>*)__xlx_apatb_param_data_in_V_user_V)->read());
    __xlx_data_in_V_user_V_V_tmp_Count++;
  }
  ap_apatb_data_in_V_user_V_V_cap_bc = __xlx_data_in_V_user_V_tmp_vec.size();
  // store input buffer
  char* __xlx_data_in_V_user_V_input_buffer= new char[__xlx_data_in_V_user_V_tmp_vec.size()];
  for (int i = 0; i < __xlx_data_in_V_user_V_tmp_vec.size(); ++i) {
    __xlx_data_in_V_user_V_input_buffer[i] = __xlx_data_in_V_user_V_tmp_vec[i];
  }
  ...
  // collect __xlx_data_in_V_id_V_tmp_vec
  unsigned __xlx_data_in_V_id_V_V_tmp_Count = 0;
  unsigned __xlx_data_in_V_id_V_V_read_Size = __xlx_data_in_V_id_V_V_size_Reader.read_size();
  vector<char> __xlx_data_in_V_id_V_tmp_vec;
  while (!((hls::stream<char>*)__xlx_apatb_param_data_in_V_id_V)->empty() && __xlx_data_in_V_id_V_V_tmp_Count < __xlx_data_in_V_id_V_V_read_Size) {
    __xlx_data_in_V_id_V_tmp_vec.push_back(((hls::stream<char>*)__xlx_apatb_param_data_in_V_id_V)->read());
    __xlx_data_in_V_id_V_V_tmp_Count++;
  }
  ap_apatb_data_in_V_id_V_V_cap_bc = __xlx_data_in_V_id_V_tmp_vec.size();
  // store input buffer
  char* __xlx_data_in_V_id_V_input_buffer= new char[__xlx_data_in_V_id_V_tmp_vec.size()];
  for (int i = 0; i < __xlx_data_in_V_id_V_tmp_vec.size(); ++i) {
    __xlx_data_in_V_id_V_input_buffer[i] = __xlx_data_in_V_id_V_tmp_vec[i];
  }
  // collect __xlx_data_in_V_dest_V_tmp_vec
  unsigned __xlx_data_in_V_dest_V_V_tmp_Count = 0;
  unsigned __xlx_data_in_V_dest_V_V_read_Size = __xlx_data_in_V_dest_V_V_size_Reader.read_size();
  vector<char> __xlx_data_in_V_dest_V_tmp_vec;
  while (!((hls::stream<char>*)__xlx_apatb_param_data_in_V_dest_V)->empty() && __xlx_data_in_V_dest_V_V_tmp_Count < __xlx_data_in_V_dest_V_V_read_Size) {
    __xlx_data_in_V_dest_V_tmp_vec.push_back(((hls::stream<char>*)__xlx_apatb_param_data_in_V_dest_V)->read());
    __xlx_data_in_V_dest_V_V_tmp_Count++;
  }
  ap_apatb_data_in_V_dest_V_V_cap_bc = __xlx_data_in_V_dest_V_tmp_vec.size();
  // store input buffer
  char* __xlx_data_in_V_dest_V_input_buffer= new char[__xlx_data_in_V_dest_V_tmp_vec.size()];
  for (int i = 0; i < __xlx_data_in_V_dest_V_tmp_vec.size(); ++i) {
    __xlx_data_in_V_dest_V_input_buffer[i] = __xlx_data_in_V_dest_V_tmp_vec[i];
  }
  ...
  //Create input buffer for data_out_V_user_V
  ap_apatb_data_out_V_user_V_V_cap_bc = __xlx_data_out_V_user_V_V_size_Reader.read_size();
  char* __xlx_data_out_V_user_V_input_buffer= new char[ap_apatb_data_out_V_user_V_V_cap_bc];
  ...
  //Create input buffer for data_out_V_id_V
  ap_apatb_data_out_V_id_V_V_cap_bc = __xlx_data_out_V_id_V_V_size_Reader.read_size();
  char* __xlx_data_out_V_id_V_input_buffer= new char[ap_apatb_data_out_V_id_V_V_cap_bc];
  //Create input buffer for data_out_V_dest_V
  ap_apatb_data_out_V_dest_V_V_cap_bc = __xlx_data_out_V_dest_V_V_size_Reader.read_size();
  char* __xlx_data_out_V_dest_V_input_buffer= new char[ap_apatb_data_out_V_dest_V_V_cap_bc];
  // DUT call
  equalizer_pilot_removal(__xlx_data_in_V_data_V_input_buffer, __xlx_data_in_V_keep_V_input_buffer, __xlx_data_in_V_strb_V_input_buffer, __xlx_data_in_V_user_V_input_buffer, __xlx_data_in_V_last_V_input_buffer, __xlx_data_in_V_id_V_input_buffer, __xlx_data_in_V_dest_V_input_buffer, __xlx_data_out_V_data_V_input_buffer, __xlx_data_out_V_keep_V_input_buffer, __xlx_data_out_V_strb_V_input_buffer, __xlx_data_out_V_user_V_input_buffer, __xlx_data_out_V_last_V_input_buffer, __xlx_data_out_V_id_V_input_buffer, __xlx_data_out_V_dest_V_input_buffer);
  ...
  for (unsigned i = 0; i <ap_apatb_data_out_V_user_V_V_cap_bc; ++i)
    ((hls::stream<char>*)__xlx_apatb_param_data_out_V_user_V)->write(__xlx_data_out_V_user_V_input_buffer[i]);
  ...
  for (unsigned i = 0; i <ap_apatb_data_out_V_id_V_V_cap_bc; ++i)
    ((hls::stream<char>*)__xlx_apatb_param_data_out_V_id_V)->write(__xlx_data_out_V_id_V_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_data_out_V_dest_V_V_cap_bc; ++i)
    ((hls::stream<char>*)__xlx_apatb_param_data_out_V_dest_V)->write(__xlx_data_out_V_dest_V_input_buffer[i]);
}
