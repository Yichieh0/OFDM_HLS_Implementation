...
$(ObjDir)/equalizer_pilot_removal.cpp_pre.cpp.tb.o : equalizer_pilot_removal.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling equalizer_pilot_removal.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/pilot_insertion.cpp_pre.cpp.tb.o : pilot_insertion.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling pilot_insertion.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
