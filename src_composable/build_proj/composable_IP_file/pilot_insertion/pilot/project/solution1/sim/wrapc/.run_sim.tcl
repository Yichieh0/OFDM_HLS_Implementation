...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pilot_insertion.autotvin.dat"
	set constFileTvOut       "pilot_insertion.autotvout.dat"
	set constFileHdlTvIn     "pilot_insertion.autohdltvin.dat"
	set constFileHdlTvOut    "pilot_insertion.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
