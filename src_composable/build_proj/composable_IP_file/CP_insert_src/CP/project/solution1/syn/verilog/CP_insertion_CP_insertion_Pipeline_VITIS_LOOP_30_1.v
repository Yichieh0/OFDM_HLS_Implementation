...
module CP_insertion_CP_insertion_Pipeline_VITIS_LOOP_30_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (p_Result_1_fu_203_p4 == 16'd3) & (icmp_ln33_fu_197_p2 == 1'd1))) begin
        CP_length_fu_94 <= CP_length_2_fu_213_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (p_Result_1_fu_203_p4 == 16'd0) & (icmp_ln33_fu_197_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (p_Result_1_fu_203_p4 == 16'd2) & (icmp_ln33_fu_197_p2 == 1'd1))) begin
        pilot_width_fu_102 <= CP_length_2_fu_213_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (p_Result_1_fu_203_p4 == 16'd1) & (icmp_ln33_fu_197_p2 == 1'd1))) begin
        sym_num_fu_98 <= CP_length_2_fu_213_p1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln53_reg_295 == 1'd1))) begin
...
always @ (*) begin
    if (((icmp_ln53_fu_237_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln33_reg_288 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln33_reg_288 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln33_reg_288 == 1'd0) & (data_out_TREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((icmp_ln33_reg_288 == 1'd0) & (data_out_TREADY == 1'b0)))) | ((data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((icmp_ln33_reg_288 == 1'd0) & (data_out_TREADY == 1'b0)))) | ((data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end
...
always @ (*) begin
    ap_block_state2_io = ((icmp_ln33_reg_288 == 1'd0) & (data_out_TREADY == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln33_reg_288 == 1'd0) & (data_out_TREADY == 1'b0));
end
...
assign icmp_ln33_fu_197_p2 = ((p_Result_s_fu_187_p4 == 16'd5) ? 1'b1 : 1'b0);

assign icmp_ln53_fu_237_p2 = ((p_Result_s_fu_187_p4 == 16'd65535) ? 1'b1 : 1'b0);
...
endmodule //CP_insertion_CP_insertion_Pipeline_VITIS_LOOP_30_1
