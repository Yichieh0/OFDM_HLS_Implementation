...
$(ObjDir)/CP_insertion.cpp_pre.cpp.tb.o : CP_insertion.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling CP_insertion.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/syn_CP_removal.cpp_pre.cpp.tb.o : syn_CP_removal.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling syn_CP_removal.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
