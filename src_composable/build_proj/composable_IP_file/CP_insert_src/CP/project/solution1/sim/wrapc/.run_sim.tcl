...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "CP_insertion.autotvin.dat"
	set constFileTvOut       "CP_insertion.autotvout.dat"
	set constFileHdlTvIn     "CP_insertion.autohdltvin.dat"
	set constFileHdlTvOut    "CP_insertion.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
