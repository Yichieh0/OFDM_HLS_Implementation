...
reg   [21:0] p_Result_9_reg_488;
wire   [21:0] p_Result_10_fu_323_p1;
reg   [21:0] p_Result_10_reg_493;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln57_fu_296_p2 == 1'd1) & (icmp_ln55_fu_244_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_Result_9_reg_488 <= {{data_in_TDATA[53:32]}};
    end
end
...
assign in_i_V_d0 = data_in_TDATA[21:0];

assign in_r_V_d0 = {{data_in_TDATA[53:32]}};

assign p_Result_10_fu_323_p1 = data_in_TDATA[21:0];

assign p_Result_11_fu_392_p5 = {{p_Val2_s_fu_110[31:22]}, {p_Result_9_reg_488}};

assign p_Result_12_fu_403_p5 = {{p_Val2_1_fu_114[31:22]}, {p_Result_10_reg_493}};

assign p_Result_13_fu_414_p3 = {{p_Result_11_fu_392_p5}, {p_Result_12_fu_403_p5}};

assign p_Result_7_fu_361_p5 = {{p_Val2_1_fu_114[31:22]}, {in_i_V_q0}};

assign p_Result_8_fu_373_p3 = {{p_Result_s_fu_349_p5}, {p_Result_7_fu_361_p5}};

assign p_Result_s_fu_349_p5 = {{p_Val2_s_fu_110[31:22]}, {in_r_V_q0}};
