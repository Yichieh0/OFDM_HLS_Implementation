...
// instant sub module
 CP_insertion_hls_deadlock_idx2_monitor CP_insertion_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 CP_insertion_hls_deadlock_idx1_monitor CP_insertion_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
