...
entity fft_top0_fftStageKernelS2S_64_2_1_1_0_6_complex_ap_fixed_24_9_5_3_0_complex_ap_fixed_16_3_5_3_0_complex_ap_fixed_16_3_5_3_0_complex_ap_fixed_22_7_5_3_0_complex_ap_fixed_24_9_5_3_0_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top0_fftStageKernelS2S_64_2_1_1_0_6_complex_ap_fixed_24_9_5_3_0_complex_ap_fixed_16_3_5_3_0_complex_ap_fixed_16_3_5_3_0_complex_ap_fixed_22_7_5_3_0_complex_ap_fixed_24_9_5_3_0_s is 
...
attribute shreg_extract : string;
    ...
    signal p_Val2_6_fu_503_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal zext_ln755_1_fu_509_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal sext_ln183_fu_499_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal r_V_4_fu_438_p2 : STD_LOGIC_VECTOR (22 downto 0);
    signal p_Val2_s_fu_513_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal r_V_5_fu_448_p2 : STD_LOGIC_VECTOR (22 downto 0);
    signal temp_out_sin_V_2_fu_480_p3 : STD_LOGIC_VECTOR (14 downto 0);
...
begin
    twiddleObj_twiddleTable_M_imag_V_U : component fft_top0_fftStageKernelS2S_64_2_1_1_0_6_complex_ap_fixed_24_9_5_3_0_complex_ap_fixed_1bkb
    generic map (
        DataWidth => 14,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    mul_mul_23s_15s_37_4_1_U59 : component fft_top0_mul_mul_23s_15s_37_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 23,
    ...
    mul_mul_23s_15s_37_4_1_U60 : component fft_top0_mul_mul_23s_15s_37_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 23,
    ...
    mul_mul_23s_15s_37_4_1_U61 : component fft_top0_mul_mul_23s_15s_37_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 23,
    ...
    mul_mul_23s_15s_37_4_1_U62 : component fft_top0_mul_mul_23s_15s_37_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 23,
    ...
    p_Val2_6_fu_503_p2 <= std_logic_vector(unsigned(ap_const_lv14_0) - unsigned(temp_out_cos_V_fu_491_p3));
    p_Val2_s_fu_513_p3 <= 
        zext_ln755_1_fu_509_p1 when (output_negate_control_real_V_reg_691(0) = '1') else 
        sext_ln183_fu_499_p1;
    ...
    real_out_V_fu_557_p2 <= std_logic_vector(unsigned(real1_V_fu_539_p4) - unsigned(real2_V_fu_548_p4));
        sext_ln1171_1_fu_524_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_s_fu_513_p3),37));

        sext_ln1171_2_fu_528_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(r_V_5_fu_448_p2),37));

        sext_ln1171_3_fu_532_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(temp_out_sin_V_2_fu_480_p3),37));
        ...
        sext_ln183_fu_499_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(temp_out_cos_V_fu_491_p3),15));
    ...
    temp_out_sin_V_2_fu_480_p3 <= 
        sext_ln166_fu_466_p1 when (output_negate_control_imag_reg_671(0) = '1') else 
    ...
    zext_ln755_1_fu_509_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_Val2_6_fu_503_p2),15));
