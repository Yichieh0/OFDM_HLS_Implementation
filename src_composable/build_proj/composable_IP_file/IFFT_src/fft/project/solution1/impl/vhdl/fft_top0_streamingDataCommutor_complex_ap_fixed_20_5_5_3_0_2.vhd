...
entity fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_2 is 
...
attribute shreg_extract : string;
    ...
    signal delay_line_stall_4_load_reg_543 : STD_LOGIC_VECTOR (0 downto 0);
    signal delay_line_stall_4_load_reg_543_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal pf_count_V_7 : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal sample_in_read_count_V_4 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    ...
    signal delayline_Array_12_q0 : STD_LOGIC_VECTOR (40 downto 0);
    ...
    signal delayline_Array_11_q0 : STD_LOGIC_VECTOR (40 downto 0);
    ...
    signal delay_line_stall_4_load_load_fu_229_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln79_11_fu_447_p3 : STD_LOGIC_VECTOR (19 downto 0);
    signal select_ln79_11_reg_579 : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal add_ln870_4_fu_321_p2 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal p_7_fu_463_p4 : STD_LOGIC_VECTOR (40 downto 0);
    ...
    signal select_ln68_11_fu_419_p3 : STD_LOGIC_VECTOR (19 downto 0);
    ...
    component fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_2_delayline_Array_12 IS
    generic (
        DataWidth : INTEGER;
...
begin
    delayline_Array_12_U : component fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_2_delayline_Array_12
    generic map (
        DataWidth => 41,
        AddressRange => 4,
        AddressWidth => 2)
    ...
    control_delayline_Array_4_U : component fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_2_control_delayline_Array_4
    generic map (
        DataWidth => 32,
        AddressRange => 4,
        AddressWidth => 2)
    ...
    delayline_Array_11_U : component fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_2_delayline_Array_12
    generic map (
        DataWidth => 41,
        AddressRange => 4,
        AddressWidth => 2)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_84)) then
                if (((fifo_has_next_sample_nbreadreq_fu_116_p3 = ap_const_lv1_0) and (delay_line_stall_4_load_load_fu_229_p1 = ap_const_lv1_0))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_212)) then
                if ((icmp_ln1049_fu_281_p2 = ap_const_lv1_1)) then 
                    pf_count_V_7 <= ap_const_lv2_0;
                elsif ((icmp_ln1049_fu_281_p2 = ap_const_lv1_0)) then 
                    pf_count_V_7 <= add_ln870_fu_287_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_4_load_reg_543 = ap_const_lv1_0)))) then
                and_ln297_reg_594 <= and_ln297_fu_505_p2;
                lshr_ln130_s_reg_589 <= delayline_Array_11_q0(39 downto 20);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (fifo_has_next_sample_nbreadreq_fu_116_p3 = ap_const_lv1_1) and (real_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                delay_line_stall_4 <= icmp_ln256_fu_327_p2;
                sample_in_read_count_V_4 <= add_ln870_4_fu_321_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (fifo_has_next_sample_nbreadreq_fu_116_p3 = ap_const_lv1_1) and (real_start = ap_const_logic_1) and (icmp_ln1049_fu_281_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                control_count_V_4 <= xor_ln251_fu_305_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (fifo_has_next_sample_nbreadreq_fu_116_p3 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                delay_line_stall_4_load_reg_543 <= delay_line_stall_4;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                delay_line_stall_4_load_reg_543_pp0_iter1_reg <= delay_line_stall_4_load_reg_543;
    ...
    add_ln870_4_fu_321_p2 <= std_logic_vector(unsigned(sample_in_read_count_V_4) + unsigned(ap_const_lv6_1));
    add_ln870_fu_287_p2 <= std_logic_vector(unsigned(pf_count_V_7) + unsigned(ap_const_lv2_1));
    ...
    ap_predicate_op79_write_state4_assign_proc : process(delay_line_stall_4_load_reg_543_pp0_iter1_reg, and_ln297_reg_594, fifo_has_next_sample_reg_534_pp0_iter1_reg)
    begin
                ap_predicate_op79_write_state4 <= (((fifo_has_next_sample_reg_534_pp0_iter1_reg = ap_const_lv1_1) and (ap_const_lv1_1 = and_ln297_reg_594)) or ((delay_line_stall_4_load_reg_543_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_lv1_1 = and_ln297_reg_594)));
    end process;
    ...
    control_delayline_Array_4_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_4_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_4_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    control_delayline_Array_4_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_4_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_4_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    delay_line_stall_4_load_load_fu_229_p1 <= delay_line_stall_4;

    delayline_Array_11_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_4_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_4_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    delayline_Array_11_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_4_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_4_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    delayline_Array_12_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_4_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_4_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    delayline_Array_12_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_4_load_reg_543, fifo_has_next_sample_reg_534, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_534 = ap_const_lv1_1) or (delay_line_stall_4_load_reg_543 = ap_const_lv1_0)))) then 
    ...
    icmp_ln1049_fu_281_p2 <= "1" when (pf_count_V_7 = ap_const_lv2_3) else "0";
    icmp_ln231_fu_345_p2 <= "1" when (ap_phi_mux_t17_phi_fu_156_p6 = ap_const_lv7_47) else "0";
    icmp_ln256_fu_327_p2 <= "0" when (sample_in_read_count_V_4 = ap_const_lv6_3F) else "1";
    ...
    select_ln68_11_fu_419_p3 <= 
        temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_375_p4 when (control_bits_V_4(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_212;
    select_ln68_12_fu_427_p3 <= 
        temp_tagged_mux_chain_input_valid_1_fu_385_p3 when (control_bits_V_4(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_0_reg_188;
    select_ln68_fu_411_p3 <= 
        temp_tagged_mux_chain_input_sample_M_real_V_1_fu_371_p1 when (control_bits_V_4(0) = '1') else 
    ...
    temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_375_p4 <= delayline_Array_12_q0(39 downto 20);
    temp_tagged_mux_chain_input_sample_M_real_V_1_fu_371_p1 <= delayline_Array_12_q0(20 - 1 downto 0);
    temp_tagged_mux_chain_input_valid_1_fu_385_p3 <= delayline_Array_12_q0(40 downto 40);
    tmp_fu_514_p7 <= (((((select_ln79_11_reg_579 & ap_const_lv12_0) & select_ln79_reg_574) & zext_ln174_fu_511_p1) & ap_const_lv12_0) & trunc_ln130_reg_584);
    trunc_ln130_fu_483_p1 <= delayline_Array_11_q0(20 - 1 downto 0);
    trunc_ln145_fu_233_p1 <= temp_dout(20 - 1 downto 0);
    trunc_ln79_fu_435_p1 <= control_delayline_Array_4_q0(1 - 1 downto 0);
    valid_flag_fu_497_p3 <= delayline_Array_11_q0(40 downto 40);
    xor_ln251_fu_305_p2 <= (control_count_V_4 xor ap_const_lv1_1);
    zext_ln174_fu_511_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln130_s_reg_589),32));
    zext_ln66_fu_397_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(control_bits_V_4),32));
end behav;
