...
module fft_top0_fft_top0_Pipeline_VITIS_LOOP_54_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln74_reg_265;
reg   [31:0] DATA_LEN_fu_86;
wire   [31:0] pilot_width_2_fu_198_p1;
wire   [15:0] p_Result_s_62_fu_188_p4;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln57_fu_182_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (p_Result_s_62_fu_188_p4 == 16'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln57_fu_182_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (p_Result_s_62_fu_188_p4 == 16'd2))) begin
        pilot_width_fu_94 <= pilot_width_2_fu_198_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln57_fu_182_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (p_Result_s_62_fu_188_p4 == 16'd1))) begin
        sym_num_fu_90 <= pilot_width_2_fu_198_p1;
    end
end

always @ (*) begin
    if (((icmp_ln74_reg_265 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln74_fu_217_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln57_reg_258 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln57_reg_258 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln57_reg_258 == 1'd0) & (data_out_TREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((icmp_ln57_reg_258 == 1'd0) & (data_out_TREADY == 1'b0)))) | ((data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((icmp_ln57_reg_258 == 1'd0) & (data_out_TREADY == 1'b0)))) | ((data_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end
...
always @ (*) begin
    ap_block_state2_io = ((icmp_ln57_reg_258 == 1'd0) & (data_out_TREADY == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln57_reg_258 == 1'd0) & (data_out_TREADY == 1'b0));
end
...
assign icmp_ln57_fu_182_p2 = ((p_Result_s_fu_172_p4 == 16'd4) ? 1'b1 : 1'b0);

assign icmp_ln74_fu_217_p2 = ((p_Result_s_fu_172_p4 == 16'd65535) ? 1'b1 : 1'b0);

assign p_Result_s_62_fu_188_p4 = {{data_in_TDATA[47:32]}};
...
endmodule //fft_top0_fft_top0_Pipeline_VITIS_LOOP_54_1
