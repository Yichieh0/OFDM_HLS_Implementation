...
module fft_top0_hls_deadlock_idx0_monitor ( // for module fft_top0_fft_top0_inst
    input wire clock,
    input wire reset,
    input wire [3:0] axis_block_sigs,
    input wire [30:0] inst_idle_sigs,
    input wire [28:0] inst_block_sigs,
...
// instant sub module
 fft_top0_hls_deadlock_idx1_monitor fft_top0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
