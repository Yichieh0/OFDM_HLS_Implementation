...
entity fft_top1_fft_top1_Pipeline_VITIS_LOOP_156_2_VITIS_LOOP_157_3_VITIS_LOOP_158_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top1_fft_top1_Pipeline_VITIS_LOOP_156_2_VITIS_LOOP_157_3_VITIS_LOOP_158_4 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln158_fu_242_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal indvar_flatten_fu_92 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln157_1_fu_254_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal indvar_flatten11_fu_96 : STD_LOGIC_VECTOR (38 downto 0);
    signal add_ln156_fu_167_p2 : STD_LOGIC_VECTOR (38 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal icmp_ln157_fu_179_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln158_fu_191_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln156_fu_185_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln156_fu_197_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln157_fu_203_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln157_fu_209_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln157_fu_248_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((icmp_ln156_fu_162_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln156_fu_162_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln156_fu_167_p2 <= std_logic_vector(unsigned(indvar_flatten11_fu_96) + unsigned(ap_const_lv39_1));
    add_ln157_fu_248_p2 <= std_logic_vector(unsigned(indvar_flatten_fu_92) + unsigned(ap_const_lv9_1));
    add_ln158_fu_242_p2 <= std_logic_vector(unsigned(select_ln157_fu_209_p3) + unsigned(ap_const_lv2_1));
    and_ln156_fu_197_p2 <= (xor_ln156_fu_185_p2 and icmp_ln158_fu_191_p2);
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, data_in_TVALID, icmp_ln156_fu_162_p2, io_acc_block_signal_op56, trunc_ln174_reg_319, io_acc_block_signal_op58)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (((io_acc_block_signal_op58 = ap_const_logic_0) and (trunc_ln174_reg_319 = ap_const_lv1_1)) or ((trunc_ln174_reg_319 = ap_const_lv1_0) and (io_acc_block_signal_op56 = ap_const_logic_0)))) or ((icmp_ln156_fu_162_p2 = ap_const_lv1_0) and (data_in_TVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, data_in_TVALID, icmp_ln156_fu_162_p2, io_acc_block_signal_op56, trunc_ln174_reg_319, io_acc_block_signal_op58)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (((io_acc_block_signal_op58 = ap_const_logic_0) and (trunc_ln174_reg_319 = ap_const_lv1_1)) or ((trunc_ln174_reg_319 = ap_const_lv1_0) and (io_acc_block_signal_op56 = ap_const_logic_0)))) or ((icmp_ln156_fu_162_p2 = ap_const_lv1_0) and (data_in_TVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, data_in_TVALID, icmp_ln156_fu_162_p2, io_acc_block_signal_op56, trunc_ln174_reg_319, io_acc_block_signal_op58)
    begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(data_in_TVALID, icmp_ln156_fu_162_p2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln156_fu_162_p2 = ap_const_lv1_0) and (data_in_TVALID = ap_const_logic_0));
    end process;
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln156_fu_162_p2, ap_block_pp0_stage0_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (icmp_ln156_fu_162_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    data_in_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, data_in_TVALID, icmp_ln156_fu_162_p2, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln156_fu_162_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    data_in_TREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln156_fu_162_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln156_fu_162_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln156_fu_162_p2 <= "1" when (indvar_flatten11_fu_96 = zext_ln156) else "0";
    icmp_ln157_fu_179_p2 <= "1" when (indvar_flatten_fu_92 = ap_const_lv9_80) else "0";
    icmp_ln158_fu_191_p2 <= "1" when (i_fu_88 = ap_const_lv2_2) else "0";
    ...
    or_ln157_fu_203_p2 <= (icmp_ln157_fu_179_p2 or and_ln156_fu_197_p2);
    ...
    select_ln157_1_fu_254_p3 <= 
        ap_const_lv9_1 when (icmp_ln157_fu_179_p2(0) = '1') else 
        add_ln157_fu_248_p2;
    select_ln157_fu_209_p3 <= 
        ap_const_lv2_0 when (or_ln157_fu_203_p2(0) = '1') else 
        i_fu_88;
    trunc_ln174_fu_235_p1 <= select_ln157_fu_209_p3(1 - 1 downto 0);
    xor_ln156_fu_185_p2 <= (icmp_ln157_fu_179_p2 xor ap_const_lv1_1);
end behav;
