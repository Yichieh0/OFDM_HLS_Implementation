...
module fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_4 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
wire   [40:0] delayline_Array_19_q0;
reg    temp_blk_n;
...
#0 pf_count_V_2 = 4'd0;
#0 sample_in_read_count_V_5 = 6'd0;
#0 delay_line_stall_5 = 1'd0;
#0 ap_enable_reg_pp0_iter1 = 1'b0;
end

fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_4_delayline_Array_20 #(
    .DataWidth( 41 ),
    .AddressRange( 16 ),
    .AddressWidth( 4 ))
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((fifo_has_next_sample_reg_534 == 1'd1) | (delay_line_stall_5_load_reg_543 == 1'd0)))) begin
        ...
        lshr_ln130_s_reg_589 <= {{delayline_Array_19_q0[39:20]}};
...
assign add_ln870_4_fu_321_p2 = (sample_in_read_count_V_5 + 6'd1);
...
assign icmp_ln256_fu_327_p2 = ((sample_in_read_count_V_5 != 6'd63) ? 1'b1 : 1'b0);

assign p_8_fu_463_p4 = {{{select_ln68_12_fu_427_p3}, {select_ln68_11_fu_419_p3}}, {select_ln68_fu_411_p3}};
...
assign select_ln68_11_fu_419_p3 = ((control_bits_V_5[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_375_p4 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_V_0_reg_212);

assign select_ln68_12_fu_427_p3 = ((control_bits_V_5[0:0] == 1'b1) ? temp_tagged_mux_chain_input_valid_1_fu_385_p3 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_0_reg_188);
...
assign temp_tagged_mux_chain_input_sample_M_imag_V_1_fu_375_p4 = {{delayline_Array_20_q0[39:20]}};

assign temp_tagged_mux_chain_input_sample_M_real_V_1_fu_371_p1 = delayline_Array_20_q0[19:0];

assign temp_tagged_mux_chain_input_valid_1_fu_385_p3 = delayline_Array_20_q0[32'd40];

assign tmp_fu_514_p7 = {{{{{{select_ln79_11_reg_579}, {12'd0}}, {select_ln79_reg_574}}, {zext_ln174_fu_511_p1}}, {12'd0}}, {trunc_ln130_reg_584}};

assign trunc_ln130_fu_483_p1 = delayline_Array_19_q0[19:0];

assign trunc_ln145_fu_233_p1 = temp_dout[19:0];

assign trunc_ln79_fu_435_p1 = control_delayline_Array_5_q0[0:0];

assign valid_flag_fu_497_p3 = delayline_Array_19_q0[32'd40];
...
endmodule //fft_top0_streamingDataCommutor_complex_ap_fixed_20_5_5_3_0_4
