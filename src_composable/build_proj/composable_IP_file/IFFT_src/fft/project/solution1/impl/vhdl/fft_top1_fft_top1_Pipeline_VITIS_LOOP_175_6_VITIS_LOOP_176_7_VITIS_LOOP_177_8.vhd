...
entity fft_top1_fft_top1_Pipeline_VITIS_LOOP_175_6_VITIS_LOOP_176_7_VITIS_LOOP_177_8 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top1_fft_top1_Pipeline_VITIS_LOOP_175_6_VITIS_LOOP_176_7_VITIS_LOOP_177_8 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln175_reg_434 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln175_fu_205_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln177_fu_267_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal indvar_flatten18_fu_108 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln176_fu_279_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal indvar_flatten34_fu_112 : STD_LOGIC_VECTOR (38 downto 0);
    signal add_ln175_fu_210_p2 : STD_LOGIC_VECTOR (38 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal icmp_ln176_fu_222_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln177_fu_234_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln117_fu_228_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln117_fu_240_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln117_fu_246_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln117_fu_252_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln176_fu_273_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((icmp_ln175_fu_205_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    i_fu_104 <= add_ln177_fu_267_p2;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    indvar_flatten18_fu_108 <= select_ln176_fu_279_p3;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    indvar_flatten34_fu_112 <= add_ln175_fu_210_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln175_reg_434 <= icmp_ln175_fu_205_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln175_fu_205_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln175_fu_210_p2 <= std_logic_vector(unsigned(indvar_flatten34_fu_112) + unsigned(ap_const_lv39_1));
    add_ln176_fu_273_p2 <= std_logic_vector(unsigned(indvar_flatten18_fu_108) + unsigned(ap_const_lv9_1));
    add_ln177_fu_267_p2 <= std_logic_vector(unsigned(select_ln117_fu_252_p3) + unsigned(ap_const_lv2_1));
    and_ln117_fu_240_p2 <= (xor_ln117_fu_228_p2 and icmp_ln177_fu_234_p2);
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln175_fu_205_p2)
    begin
        if (((icmp_ln175_fu_205_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_phi_mux_p_04_0_0_0_0_phi_fu_172_p4_assign_proc : process(p_outData_V_M_real_V_0_dout, icmp_ln175_reg_434, trunc_ln145_reg_438, p_outData_V_M_real_V_1_dout, ap_phi_reg_pp0_iter2_p_04_0_0_0_0_reg_169)
    begin
        if ((icmp_ln175_reg_434 = ap_const_lv1_0)) then
    ...
    ap_phi_mux_p_15_0_0_0_0_phi_fu_181_p4_assign_proc : process(p_outData_V_M_imag_V_0_dout, icmp_ln175_reg_434, trunc_ln145_reg_438, p_outData_V_M_imag_V_1_dout, ap_phi_reg_pp0_iter2_p_15_0_0_0_0_reg_178)
    begin
        if ((icmp_ln175_reg_434 = ap_const_lv1_0)) then
            if ((trunc_ln145_reg_438 = ap_const_lv1_0)) then 
    ...
    ap_predicate_op53_read_state3_assign_proc : process(icmp_ln175_reg_434, trunc_ln145_reg_438)
    begin
                ap_predicate_op53_read_state3 <= ((trunc_ln145_reg_438 = ap_const_lv1_0) and (icmp_ln175_reg_434 = ap_const_lv1_0));
    end process;


    ap_predicate_op57_read_state3_assign_proc : process(icmp_ln175_reg_434, trunc_ln145_reg_438)
    begin
                ap_predicate_op57_read_state3 <= ((trunc_ln145_reg_438 = ap_const_lv1_1) and (icmp_ln175_reg_434 = ap_const_lv1_0));
    end process;
    ...
    icmp_ln175_fu_205_p2 <= "1" when (indvar_flatten34_fu_112 = zext_ln160) else "0";
    icmp_ln176_fu_222_p2 <= "1" when (indvar_flatten18_fu_108 = ap_const_lv9_80) else "0";
    icmp_ln177_fu_234_p2 <= "1" when (i_fu_104 = ap_const_lv2_2) else "0";
    ...
    or_ln117_fu_246_p2 <= (icmp_ln176_fu_222_p2 or and_ln117_fu_240_p2);
    ...
    select_ln117_fu_252_p3 <= 
        ap_const_lv2_0 when (or_ln117_fu_246_p2(0) = '1') else 
        i_fu_104;
    select_ln176_fu_279_p3 <= 
        ap_const_lv9_1 when (icmp_ln176_fu_222_p2(0) = '1') else 
        add_ln176_fu_273_p2;
    trunc_ln145_fu_260_p1 <= select_ln117_fu_252_p3(1 - 1 downto 0);
    ...
    xor_ln117_fu_228_p2 <= (icmp_ln176_fu_222_p2 xor ap_const_lv1_1);
end behav;
