...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fft_top0.autotvin.dat"
	set constFileTvOut       "fft_top0.autotvout.dat"
	set constFileHdlTvIn     "fft_top0.autohdltvin.dat"
	set constFileHdlTvOut    "fft_top0.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
