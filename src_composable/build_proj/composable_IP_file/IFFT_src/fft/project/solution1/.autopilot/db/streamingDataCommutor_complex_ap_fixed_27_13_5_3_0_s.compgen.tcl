...
set ID 106
set hasByteEnable 0
set MemName fft_top0_streamingDataCommutor_complex_ap_fixed_27_13_5_3_0_s_delayline_Array_14
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fftOutData_local2_din { O 128 vector } fftOutData_local2_full_n { I 1 bit } fftOutData_local2_write { O 1 bit } } \
} "
}
