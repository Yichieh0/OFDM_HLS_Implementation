...
set ID 23
set hasByteEnable 0
set MemName fft_top0_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_s_delayline_Array_18
...
set ID 24
set hasByteEnable 0
set MemName fft_top0_streamingDataCommutor_complex_ap_fixed_22_7_5_3_0_s_control_delayline_Array_4
set CoreName ShiftReg
set PortList { 2 }
set DataWd 32
set AddrRange 1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_temp \
    op interface \
    ports { temp_din { O 128 vector } temp_full_n { I 1 bit } temp_write { O 1 bit } } \
} "
}
