...
set name symbol_to_pixl_mul_32s_32s_32_1_1
...
# RegSlice definition:
set ID 31
set RegSliceName symbol_to_pixl_regslice_both
set RegSliceInstName symbol_to_pixl_regslice_both_U
set CoreName ap_simcore_symbol_to_pixl_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
