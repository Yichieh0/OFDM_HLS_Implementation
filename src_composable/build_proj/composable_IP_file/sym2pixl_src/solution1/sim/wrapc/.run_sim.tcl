...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "symbol_to_pixl.autotvin.dat"
	set constFileTvOut       "symbol_to_pixl.autotvout.dat"
	set constFileHdlTvIn     "symbol_to_pixl.autohdltvin.dat"
	set constFileHdlTvOut    "symbol_to_pixl.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
