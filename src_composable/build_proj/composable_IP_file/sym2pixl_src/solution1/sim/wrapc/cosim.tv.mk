...
$(ObjDir)/pixl_to_symbol.cpp_pre.cpp.tb.o : pixl_to_symbol.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling pixl_to_symbol.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/symbol_to_pixl.cpp_pre.cpp.tb.o : symbol_to_pixl.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling symbol_to_pixl.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
