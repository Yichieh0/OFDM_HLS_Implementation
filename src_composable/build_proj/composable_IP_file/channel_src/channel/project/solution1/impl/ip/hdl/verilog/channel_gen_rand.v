...
module channel_gen_rand (
        ...
        ap_ready,
        random_num3774_din,
        random_num3774_full_n,
        random_num3774_write
);
...
output   ap_idle;
output   ap_ready;
output  [21:0] random_num3774_din;
input   random_num3774_full_n;
output   random_num3774_write;

reg ap_done;
reg ap_idle;
reg ap_ready;
reg random_num3774_write;
...
wire   [21:0] trunc_ln595_fu_1558_p1;
wire   [21:0] select_ln597_fu_1574_p3;
wire   [21:0] trunc_ln592_fu_1538_p1;
wire   [21:0] sext_ln590cast_fu_1596_p1;
wire   [0:0] icmp_ln612_fu_1590_p2;
wire   [21:0] shl_ln613_fu_1600_p2;
wire   [0:0] icmp_ln591_fu_1532_p2;
wire   [0:0] xor_ln580_fu_1614_p2;
wire   [0:0] and_ln591_fu_1619_p2;
wire   [21:0] select_ln612_fu_1606_p3;
wire   [0:0] or_ln591_fu_1633_p2;
wire   [0:0] xor_ln591_fu_1638_p2;
wire   [0:0] and_ln590_fu_1644_p2;
wire   [21:0] select_ln594_fu_1582_p3;
wire   [21:0] select_ln591_fu_1625_p3;
wire   [21:0] select_ln590_fu_1650_p3;
...
always @ (*) begin
    if ((random_num3774_full_n == 1'b0)) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((random_num3774_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state52)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((random_num3774_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state52))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state52)) begin
        ...
        random_num3774_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((random_num3774_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state52))) begin
        random_num3774_write = 1'b1;
    end else begin
        random_num3774_write = 1'b0;
    end
end
...
assign icmp_ln612_fu_1590_p2 = ((sh_amt_fu_1520_p3 < 12'd22) ? 1'b1 : 1'b0);
...
assign random_num3774_din = ((icmp_ln580_reg_1845[0:0] == 1'b1) ? 22'd0 : select_ln590_fu_1650_p3);
...
assign select_ln597_fu_1574_p3 = ((tmp_24_fu_1566_p3[0:0] == 1'b1) ? 22'd4194303 : 22'd0);

assign select_ln612_fu_1606_p3 = ((icmp_ln612_fu_1590_p2[0:0] == 1'b1) ? shl_ln613_fu_1600_p2 : 22'd0);
...
assign sext_ln590cast_fu_1596_p1 = sext_ln590_fu_1528_p1[21:0];
...
assign trunc_ln592_fu_1538_p1 = man_V_2_fu_1479_p3[21:0];

assign trunc_ln595_fu_1558_p1 = ashr_ln595_fu_1552_p2[21:0];
