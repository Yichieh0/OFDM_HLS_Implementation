...
module channel_gen_channel_gen_Pipeline_VITIS_LOOP_183_12 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [19:0] lhs_V_fu_56;
wire    ap_loop_init;
reg   [19:0] lhs_V_8_fu_60;
reg   [2:0] i_V_fu_64;
reg   [2:0] ap_sig_allocacmp_i_V_8;
wire   [2:0] add_ln870_fu_170_p2;
wire    ap_block_pp0_stage0_01001;
wire  signed [34:0] grp_fu_300_p2;
wire   [19:0] r_V_21_fu_201_p4;
wire  signed [19:0] mul_ln1245_fu_226_p0;
wire  signed [34:0] sext_ln1171_3_fu_210_p1;
wire   [34:0] lhs_V_9_fu_218_p3;
wire   [34:0] mul_ln1245_fu_226_p2;
wire   [34:0] ret_V_fu_232_p2;
wire  signed [19:0] mul_ln1245_2_fu_260_p0;
wire   [34:0] lhs_V_10_fu_252_p3;
wire   [34:0] mul_ln1245_2_fu_260_p2;
wire   [34:0] ret_V_13_fu_266_p2;
...
channel_gen_channel_gen_Pipeline_VITIS_LOOP_183_12_weight_6taps #(
    .DataWidth( 15 ),
    .AddressRange( 6 ),
    .AddressWidth( 3 ))
weight_6taps_U(
...
channel_gen_mul_20s_20s_35_1_1 #(
    ...
    .din1_WIDTH( 20 ),
    .dout_WIDTH( 35 ))
mul_20s_20s_35_1_1_U72(
    .din0(mul_ln1245_2_fu_260_p0),
    .din1(x_imag_6taps_V_q0),
    .dout(mul_ln1245_2_fu_260_p2)
);

channel_gen_mul_mul_20s_15ns_35_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 20 ),
    .din1_WIDTH( 15 ),
    .dout_WIDTH( 35 ))
mul_mul_20s_15ns_35_4_1_U73(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(n_6taps_V_q0),
    .din1(grp_fu_300_p1),
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            lhs_V_8_fu_60 <= {{ret_V_13_fu_266_p2[34:15]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            lhs_V_fu_56 <= {{ret_V_fu_232_p2[34:15]}};
        end
    end
end
...
assign r_V_21_fu_201_p4 = {{grp_fu_300_p2[34:15]}};
...
endmodule //channel_gen_channel_gen_Pipeline_VITIS_LOOP_183_12
