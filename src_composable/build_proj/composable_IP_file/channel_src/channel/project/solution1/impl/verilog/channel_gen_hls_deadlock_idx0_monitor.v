...
module channel_gen_hls_deadlock_idx0_monitor ( // for module channel_gen_channel_gen_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 channel_gen_hls_deadlock_idx1_monitor channel_gen_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
