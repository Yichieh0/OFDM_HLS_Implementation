...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "channel_gen.autotvin.dat"
	set constFileTvOut       "channel_gen.autotvout.dat"
	set constFileHdlTvIn     "channel_gen.autohdltvin.dat"
	set constFileHdlTvOut    "channel_gen.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
