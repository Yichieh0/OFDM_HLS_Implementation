...
HLS_SOURCES = ../../../../src/main.cpp ../../../../src/rand.cpp ../../../../src/channel_gen.cpp
...
$(ObjDir)/rand.o: ../../../../src/rand.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/rand.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/rand.d

$(ObjDir)/channel_gen.o: ../../../../src/channel_gen.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/channel_gen.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
