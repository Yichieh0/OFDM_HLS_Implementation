...
HLS_SOURCES = ../../../../../main.cpp ../../../../../deQAM.cpp ../../../../../QAM.cpp
...
$(ObjDir)/deQAM.o: ../../../../../deQAM.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../deQAM.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/deQAM.d

$(ObjDir)/QAM.o: ../../../../../QAM.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../QAM.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
