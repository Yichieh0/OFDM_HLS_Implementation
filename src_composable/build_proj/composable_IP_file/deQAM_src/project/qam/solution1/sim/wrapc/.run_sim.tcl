...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "deQAM.autotvin.dat"
	set constFileTvOut       "deQAM.autotvout.dat"
	set constFileHdlTvIn     "deQAM.autohdltvin.dat"
	set constFileHdlTvOut    "deQAM.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
