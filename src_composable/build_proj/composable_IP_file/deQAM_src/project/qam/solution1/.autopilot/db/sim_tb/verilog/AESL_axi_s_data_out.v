...
`define TV_OUT_data_out_TDATA "./impl_rtl.deQAM.autotvout_data_out_V_data_V.dat"
`define EGRESS_STATUS_data_out_TDATA "./stream_egress_status_data_out_V_data_V.dat"
`define TV_OUT_data_out_TKEEP "./impl_rtl.deQAM.autotvout_data_out_V_keep_V.dat"
`define EGRESS_STATUS_data_out_TKEEP "./stream_egress_status_data_out_V_keep_V.dat"
`define TV_OUT_data_out_TSTRB "./impl_rtl.deQAM.autotvout_data_out_V_strb_V.dat"
`define EGRESS_STATUS_data_out_TSTRB "./stream_egress_status_data_out_V_strb_V.dat"
`define TV_OUT_data_out_TUSER "./impl_rtl.deQAM.autotvout_data_out_V_user_V.dat"
`define EGRESS_STATUS_data_out_TUSER "./stream_egress_status_data_out_V_user_V.dat"
`define TV_OUT_data_out_TLAST "./impl_rtl.deQAM.autotvout_data_out_V_last_V.dat"
`define EGRESS_STATUS_data_out_TLAST "./stream_egress_status_data_out_V_last_V.dat"
`define TV_OUT_data_out_TID "./impl_rtl.deQAM.autotvout_data_out_V_id_V.dat"
`define EGRESS_STATUS_data_out_TID "./stream_egress_status_data_out_V_id_V.dat"
`define TV_OUT_data_out_TDEST "./impl_rtl.deQAM.autotvout_data_out_V_dest_V.dat"
`define EGRESS_STATUS_data_out_TDEST "./stream_egress_status_data_out_V_dest_V.dat"
