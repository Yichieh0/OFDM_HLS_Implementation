...
module deQAM_deQAM_Pipeline_VITIS_LOOP_75_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [3:0] select_ln75_cast_fu_108_p1;
reg  signed [3:0] select_ln75_cast_reg_267;
...
reg   [3:0] v_V_0_fu_60;
wire   [3:0] select_ln76_fu_210_p3;
...
wire   [19:0] zext_ln1549_fu_190_p1;
...
deQAM_dcmp_64ns_64ns_1_1_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_1_no_dsp_1_U11(
...
assign add_ln70_fu_205_p2 = ($signed(v_V_0_fu_60) + $signed(select_ln75_cast_reg_267));
...
assign select_ln75_cast_fu_108_p1 = $signed(select_ln75);

assign select_ln76_fu_210_p3 = ((xor_ln1549_fu_199_p2[0:0] == 1'b1) ? add_ln70_fu_205_p2 : v_V_0_fu_60);
...
endmodule //deQAM_deQAM_Pipeline_VITIS_LOOP_75_3
