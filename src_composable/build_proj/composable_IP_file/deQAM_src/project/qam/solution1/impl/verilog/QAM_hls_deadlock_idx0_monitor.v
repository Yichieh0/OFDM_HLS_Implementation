...
module QAM_hls_deadlock_idx0_monitor ( // for module QAM_QAM_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 QAM_hls_deadlock_idx2_monitor QAM_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 QAM_hls_deadlock_idx1_monitor QAM_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
