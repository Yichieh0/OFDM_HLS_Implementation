...
attribute shreg_extract : string;
    ...
    signal decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_start : STD_LOGIC;
    signal decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_done : STD_LOGIC;
    signal decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_continue : STD_LOGIC;
    signal decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_idle : STD_LOGIC;
    signal decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_ready : STD_LOGIC;
    signal decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_temp_trellis_survivor_V_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_temp_trellis_survivor_V_ce0 : STD_LOGIC;
    signal decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_return : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component decoder_decoder_bit_Loop_VITIS_LOOP_227_6_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        t_address0 => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_temp_trellis_survivor_V_address0,
        t_ce0 => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_temp_trellis_survivor_V_ce0,
        ...
        t_read => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_ready);
    ...
    decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0 : component decoder_decoder_bit_Loop_VITIS_LOOP_227_6_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_start,
        ap_done => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_done,
        ap_continue => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_continue,
        ap_idle => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_idle,
        ap_ready => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_ready,
        p_read => best_branch_loc_channel_dout,
        temp_trellis_survivor_V_address0 => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_temp_trellis_survivor_V_address0,
        temp_trellis_survivor_V_ce0 => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_temp_trellis_survivor_V_ce0,
        temp_trellis_survivor_V_q0 => temp_trellis_survivor_V_t_q0,
        ap_return => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_return);
    ...
    port map (
        ...
        if_read => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_ready);
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_return,
        if_full_n => best_branch_3_cast_loc_channel_full_n,
        if_write => decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_done,
    ...
    ap_done <= decoder_bit_Block_split223_proc_U0_ap_done;
    ap_idle <= ((best_branch_3_cast_loc_channel_empty_n xor ap_const_logic_1) and (best_branch_loc_channel_empty_n xor ap_const_logic_1) and (temp_trellis_survivor_V_t_empty_n xor ap_const_logic_1) and decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_idle and decoder_bit_Block_split223_proc_U0_ap_idle and decoder_bit_Block_split148_proc3_U0_ap_idle);
    ap_ready <= decoder_bit_Block_split148_proc3_U0_ap_ready;
    ...
    decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_continue <= best_branch_3_cast_loc_channel_full_n;
    decoder_bit_Loop_VITIS_LOOP_227_6_proc_U0_ap_start <= (temp_trellis_survivor_V_t_empty_n and best_branch_loc_channel_empty_n);
    output302_din <= decoder_bit_Block_split223_proc_U0_output302_din;
    output302_write <= decoder_bit_Block_split223_proc_U0_output302_write;
    y0300_read <= decoder_bit_Block_split148_proc3_U0_y0300_read;
    y1301_read <= decoder_bit_Block_split148_proc3_U0_y1301_read;
