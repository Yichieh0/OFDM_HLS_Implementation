...
HLS_SOURCES = ../../../src/main.cpp ../../../src/decoder.cpp ../../../src/encoder.cpp
...
$(ObjDir)/decoder.o: ../../../src/decoder.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../src/decoder.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/decoder.d

$(ObjDir)/encoder.o: ../../../src/encoder.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../src/encoder.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
