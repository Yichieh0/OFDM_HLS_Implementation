...
#ifndef _decoder_decoder_bit_temp_trellis_survivor_V_H_
#define _decoder_decoder_bit_temp_trellis_survivor_V_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "decoder_decoder_bit_temp_trellis_survivor_V_memcore.h"

SC_MODULE(decoder_decoder_bit_temp_trellis_survivor_V) {
    static const unsigned int DataWidth    = 33;
...
protected:
    ...
    decoder_decoder_bit_temp_trellis_survivor_V_memcore* decoder_decoder_bit_temp_trellis_survivor_V_memcore_U;
...
public:
    ...
    SC_CTOR(decoder_decoder_bit_temp_trellis_survivor_V) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U = new decoder_decoder_bit_temp_trellis_survivor_V_memcore("decoder_decoder_bit_temp_trellis_survivor_V_memcore_U");
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->clk      ( clk );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->reset    ( reset );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->ce0      ( i_ce0 );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->we0      ( i_we0 );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->address0 ( memcore_iaddr );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->d0       ( i_d0 );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->q0       ( i_q0 );

        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->ce1      ( t_ce0 );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->we1      ( t_we0 );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->address1 ( memcore_taddr );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->d1       ( t_d0 );
        decoder_decoder_bit_temp_trellis_survivor_V_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "decoder_decoder_bit_temp_trellis_survivor_V.trace");
            // ports
