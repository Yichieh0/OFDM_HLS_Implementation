set moduleName decoder_bit_Block_split223_proc
set isTopModule 0
...
set C_modelName {decoder_bit_Block_.split223_proc}
...
set portList { 
	...
	{ output302_din sc_out sc_lv 1 signal 1 } 
	{ output302_full_n sc_in sc_logic 1 signal 1 } 
	{ output302_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
