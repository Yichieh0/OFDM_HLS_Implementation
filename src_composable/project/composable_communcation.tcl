...
#
# Generated by Vivado on Thu Feb 23 18:59:05 CST 2023
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/QAM_RTL_IP"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/vivado_composable_project"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse commun.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vivado_composable_project/composable_communcation.gen/sources_1/bd/commun/hdl/commun_wrapper.v" ]
} else {
