...
The vivado project could be automatically built under the folder `project/vivado_project/` and the bitstream would be generated by the command `bash run_vivado.sh`.  
